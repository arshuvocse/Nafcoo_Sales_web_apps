<%@ page title="" language="C#" masterpagefile="~/MasterPages/NewMasterPage.master" autoeventwireup="true" inherits="Approval_UI_MillageApprovalList, App_Web_liiy2xgc" %>
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Mileage Approval List</div>
...
<br />        
 ...
 />
                                    ...
                                    <asp:BoundField DataField="MileageAmount" HeaderText="Expense"  />
             ...
             runat="server" class="fancybox "  >
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                             <asp:HiddenField runat="server" ID="hfAppStatus" Value='<%#Eval("ApprovalStatusWeb")%>' />
