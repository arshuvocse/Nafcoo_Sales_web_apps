   ...
   public class EmployeeInformationDaL
    {
        ...
        public DataTable GetEmployeeInformationListForReport(string Param)
        {
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SalesDB);
                ...
                DataTable dt = accessManager.GetDataTable("sp_Get_EmployeeInformationListRpt_new", aSqlParameterlist);
                return dt;
            }
            catch (Exception e)
            {
