...
namespace Library.DAL.MasterSetup_DAL
{
    public class CustomerInfoDAL
    {
        ...
        public DataTable GetCustomerReport(string Parm)
        {
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SalesDB);
                ...
                DataTable dt = accessManager.GetDataTable("sp_Get_CustMasterList_Report", aSqlParameterlist);
                return dt;
            }
            catch (Exception e)
            {
        ...
        public ResultInfo SaveInfo(CustMasterInfoDAO master, String _ProLineArray, string sessionUser)
        {
            ...
            try
            {
                ...
                gSqlParameterList.Add(new SqlParameter("@TermOfPayment", master.TermOfPayment ?? (object)DBNull.Value));

                gSqlParameterList.Add(new SqlParameter("@CategoryId", master.CategoryId ?? (object)DBNull.Value));
        ...
        public DataTable GetCustomerListForApproval(string Parm)
        {
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SalesDB);
                ...
                aSqlParameterlist.Add(new SqlParameter("@Parm", Parm));
                DataTable dt = accessManager.GetDataTable("sp_Get_CustomerListForApproval", aSqlParameterlist);
        ...
        public ResultInfo SaveExpenseClaim_ApplogDAL(OrderSaveApprovalLogDAO atten)
        {
            ...
            try
            {
                ...
                aInformation.isSuccess = accessManager.SaveData("sp_web_SaveExpanseAppLog", gSqlParameterList);
