...
//            return aCommonInternalDal.DataContainerDataTable(query, "SSIDB");
        ...
        public DataTable LoadDepositSlipSummary(DateTime fromdate, DateTime todate)
        {
        ...
        public DataTable LoadSummaryProductcodewiseGyash(DateTime fromdate, DateTime todate, string Type)
        {
            ...
            return aCommonInternalDal.GetDataTableAction("sp_BusinessSummaryMISReport_All", aSqlParameterList, "SSIDB");
...
//            return aCommonInternalDal.DataContainerDataTable(query, "SSIDB");
        ...
        public DataTable DZSMwiseLoadSummaryparm(string fromdate, string todate, string parm)
        {
            ...
            return aCommonInternalDal.GetDataTableAction("sp_GET_DZSMwiseReportParam", aSqlParameterList, "SSIDB");
