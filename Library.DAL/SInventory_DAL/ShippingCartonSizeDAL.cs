...
namespace Library.DAL.SInventory_DAL
{
    public class ShippingCartonSizeDAL
    {
        ...
        {
            string query = "select * from tblProductCase where CaseQty = '" + aShippingCartonSize.CaseQty + "'";
        ...
        public bool UpdateShippingCartonSizeInfo(ShippingCartonSize aShippingCartonSize)
        {
            ...
            string query = @"UPDATE tblProductCase SET CaseQty='" + aShippingCartonSize.CaseQty + "',PcsPerCase='" + aShippingCartonSize.PcsPerCase + "' WHERE CaseId=" + aShippingCartonSize.CaseId + "";
