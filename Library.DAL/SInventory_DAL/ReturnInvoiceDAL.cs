...
namespace Library.DAL.SInventory_DAL
{
    public class ReturnInvoiceDAL
    {
     ...
     "     ReturnInvoiceNo , " +
       ...
       "    ComUnitId , " +
        ...
        "   TotalSpecialAmount, " +
         "   OldTradePolicy, " +
          "   ProductOffer,Remarks,MIACode,MIAName,MarketCode,MarketName,AreaCode,DisCode,FEName,RegionCode,DZSMName,FixedCustomer,DeliveryPersonName,DeliveryPersonPhNo,InvoiceId,IsSalesReturnWithoutOrder,SubInvoiceId " +
      "   ) " +
      " VALUES  ( '" + aInvoice.InvoiceId + "' , " +
       "    '" + aInvoice.InvoiceNo + "' , " +
      "    '" + aInvoice.InvoiceDate + "' , " +
         "    '" + aInvoice.Issubdeport + "' , " +
      "    '" + aInvoice.createBy + "' , " +
      "    '" + aInvoice.Createdate + "' , " +
      ...
      "     '" + aInvoice.TpVat + "' , " +
       ...
       aInvoice.AreaCode + "','" + aInvoice.DisCode + "','" + aInvoice.FEName + "','" + aInvoice.RegionCode + "'" +
                                 ",'" + aInvoice.DZSMName + "','" + aInvoice.FixedCustomer + "','" + aInvoice.DpNAme + "','" + aInvoice.DpMob + "' ,'" + invoiceid + "' ,'" + aInvoice.IsSalesReturnWithoutOrder + "','" + subinvoiceid + "'   " +
      "   ) ";
 ...
 "  VALUES  ( '" + amountDao.CustomerId + "' , " +
      ...
      "     )";
        ...
        {
            string insertQuery = @" DELETE FROM dbo.tblReturnInvoice WHERE ReturnInvoiceId='" + id + "' DELETE FROM dbo.tblReturnInvoiceDetail WHERE ReturnInvoiceId='" + id + "' DELETE FROM dbo.tblReturnAmount WHERE ReturnInvoiceId='" + id + "' DELETE FROM tblDCStoreFreeze where ReturnInvoiceDetailId IN (SELECT ReturnInvoiceDetailId FROM dbo.tblReturnInvoiceDetail WHERE ReturnInvoiceId='"+id+"') ";
        ...
        {
            string query = @"SELECT * FROM dbo.tblInvoiceDetail WHERE InvoiceDetailId='"+invoicedetailId+"'";
            return aCommonInternalDal.DataContainerDataTable(query, "SSIDB");
        }
...
LEFT JOIN dbo.tblOrderDetail ON dbo.tblOrder.OrderId = dbo.tblOrderDetail.OrderId WHERE dbo.tblOrder.OrderId='" + orderid + "' AND ProductCode='" + productCode + "'";
        ...
        {
            string query = @"SELECT *,ReturnInvoiceNo,OrderNo,TpTotal FROM dbo.tblReturnInvoice WHERE (ReturnInvoiceDate BETWEEN '" + fromdate + "' AND '" + todate + "') AND ComUnitId='" + dcid + "'  ";
            return aCommonInternalDal.DataContainerDataTable(query, "SSIDB");
        }
        ...
        public DataTable LoadSalesReuturnInvoice(string fromdate, string todate, string dcid)
        {
            ...
            WHERE (ReturnInvoiceDate BETWEEN '" + fromdate + "' AND '" + todate + "') AND tblReturnInvoice.ComUnitId='" + dcid + "' AND IsSalesReturnWithoutOrder ='No order' ";
        ...
        public DataTable LoadSalesReuturnInvoiceSub(string fromdate, string todate, string dcid)
        {
            string query = @"SELECT *,ReturnInvoiceNo,OrderNo,TpTotal FROM dbo.tblReturnInvoice
            LEFT JOIN dbo.tblCustMaster ON tblCustMaster.CustomerMasterId = tblReturnInvoice.CustomerMasterId
            WHERE ISSubdeport=1 and  (ReturnInvoiceDate BETWEEN '" + fromdate + "' AND '" + todate + "') AND tblReturnInvoice.ComUnitId='" + dcid + "' AND IsSalesReturnWithoutOrder ='No order' ";
        ...
        {
            string query = "SELECT * FROM dbo.tblSubDepotStoreFreeze WHERE SubDCStoreId='"+dcstoreId+"'";
            return aCommonInternalDal.DataContainerDataTable(query, "SSIDB");
        }
      ...
      //  }
        ...
        {
            string updateQuery = @"UPDATE tblReturnInvoice SET DeliveryTpTotal='" + aInvoice.TpTotal + "',DeliveryTpDiscount='" + aInvoice.TpDiscount + "',DeliveryTpVat='" + aInvoice.TpVat + "'," +
        ...
        {
            string updateQuery = @"UPDATE tblReturnInvoiceDetail SET DeliveryQuantity='" + aInvoiceDetail.Quantity + "',DeliveryBonusQuantity='" + aInvoiceDetail.BonusQuantity + "',DeliveryTotalQuantity='" + aInvoiceDetail.TotalQuantity+ "'," +
        ...
        {
            string query = @"SELECT * FROM tblDCStore WHERE ProductCode='" + productCode.Trim() + "' AND ComUnitId='" + comUnitId.Trim() + "' AND StockQty>0 ORDER BY ExpDate ASC";
            return aCommonInternalDal.DataContainerDataTable(query, "SSIDB");
        }
...
INNER JOIN dbo.tblDCStore DS ON DS.DCStoreId = ID.DCStoreId
       ...
       "  ( DCStoreId , " +
         ...
         "    ReqChildId , " +
         "    StockInTransfarId, " +
         "    StockCondition,ChalanDetailsId,ReturnInvoiceDetailId " +
        "   ) " +
        "   VALUES  ( '" + aDcStockNew.DCStoreId + "' , " +
        "     '" + aDcStockNew.DCStoreFreezeId + "' , " +
        "     '" + aDcStockNew.InvoiceDetailId + "' , " +
       ...
       "      'ReturnStock','" + (aDcStockNew.ChalanDetailsId ?? Convert.DBNull) + "','" + (ReturnInvoiceDetailId ?? Convert.DBNull) + "'  " +
      "     )";
            return aCommonInternalDal.SaveDataByInsertCommand(query, "SSIDB");
        }
       ...
       "  ( SubDCStoreId , " +
         ...
         "    ReqChildId , " +
         "    StockInTransfarId, " +
         "    StockCondition,SChalanDetailsId,ReturnInvoiceDetailId " +
        "   ) " +
        "   VALUES  ( '" + aDcStockNew.DCStoreId + "' , " +
        "     '" + aDcStockNew.DCStoreFreezeId + "' , " +
        "     '" + aDcStockNew.InvoiceDetailId + "' , " +
      ...
      "     )";
        ...
        {
            string query = @"SELECT '" + fromDate + "' as fromdate ,'" + toDate + "' as todate ,CU.ComUnitCode,CU.ComUnitName,C.CustomerCode,C.CustomerName,I.OrderNo,CONVERT(VARCHAR,I.OrderDate,103) OrderDate,I.InvoiceNo, CONVERT(VARCHAR,I.InvoiceDate,103) InvoiceDate, tblDetails.NetAmount AS NetAmount,tblDetails.UnitVatAmount AS TotalPriceVatAmount,tblDetails.TotalPriceVatAmount  AS DiscountAmount,I.AreaCode,I.RegionCode as MiaCode,I.DisCode AS DistrictCode ,I.MarketCode,I.MarketName,DATEDIFF(DAY,DATEADD(day, -1, InvoiceDate), GETDATE()) IntransitDay,I.MIACode as MainMIOCODE,I.MIAName as MainMIONAME,C.Type as SpecialAmount FROM dbo.tblInvoice I WITH(nolock) INNER JOIN ( select InvoiceId,((Sum(TotalPrice)+Sum(TotalPriceVatAmount))-Sum(DiscountAmount))NetAmount,Sum(TotalPriceVatAmount)UnitVatAmount,(Sum(DiscountAmount))TotalPriceVatAmount from dbo.tblInvoiceDetail group by  InvoiceId) tblDetails ON I.InvoiceId = tblDetails.InvoiceId INNER JOIN dbo.tblCompanyUnit CU ON CU.ComUnitId = I.ComUnitId INNER JOIN View_CustomerMaster C ON C.CustomerMasterId = I.CustomerMasterId where I.TpTotal>0 AND I.DelivaryInvoiceNo IS NULL and I.AreaCode='" + market + "'  and CU.ComUnitId='" + districtId.Trim() + "' and I.InvoiceDate between '" + fromDate + "' and '" + toDate + "' UNION ALL SELECT '" + fromDate + "' as fromdate ,'" + toDate + "' as todate ,CU.ComUnitCode,CU.ComUnitName,C.CustomerCode,C.CustomerName,I.OrderNo,CONVERT(VARCHAR,I.OrderDate,103) OrderDate,I.InvoiceNo, CONVERT(VARCHAR,I.InvoiceDate,103) InvoiceDate, I.TpGrandTotal AS NetAmount,I.TpVat AS TotalPriceVatAmount,I.TpDiscount AS DiscountAmount,I.AreaCode,I.RegionCode as MiaCode,I.DisCode AS DistrictCode ,I.MarketCode,I.MarketName,DATEDIFF(DAY,DATEADD(day, -1, InvoiceDate), GETDATE()) IntransitDay,I.MIACode as MainMIOCODE,I.MIAName as MainMIONAME,C.Type as SpecialAmount FROM dbo.tblSubInvoiceMaster I WITH(nolock) INNER JOIN dbo.tblCompanyUnit CU ON CU.ComUnitId = I.ComUnitId INNER JOIN View_CustomerMaster C ON C.CustomerMasterId = I.CustomerMasterId where I.TpTotal>0 AND I.DelivaryInvoiceNo IS NULL and I.AreaCode='" + market + "'  and CU.ComUnitId='" + districtId.Trim() + "'  and I.InvoiceDate between '" + fromDate + "' and '" + toDate + "' ORDER BY DATEDIFF(DAY,DATEADD(day, -1, InvoiceDate), GETDATE()) DESC";
            return aCommonInternalDal.DataContainerDataTable(query, "SSIDB");
        }
        public DataTable IntransitReportDAl(string districtId, DateTime fromDate, DateTime toDate)
        {
            string query =
                       @"SELECT '" + fromDate + "' as fromdate ,'" + toDate + "' as todate ,CU.ComUnitCode,CU.ComUnitName,C.CustomerCode,C.CustomerName,I.OrderNo,CONVERT(VARCHAR,I.OrderDate,103) OrderDate,I.InvoiceNo,CONVERT(VARCHAR,I.InvoiceDate,103) InvoiceDate,tblDetails.NetAmount AS NetAmount,tblDetails.UnitVatAmount AS TotalPriceVatAmount,tblDetails.TotalPriceVatAmount  AS DiscountAmount,I.AreaCode,I.RegionCode as MiaCode,I.DisCode AS DistrictCode,I.MarketCode,I.MarketName,DATEDIFF(DAY,DATEADD(day, -1, InvoiceDate), GETDATE()) IntransitDay,I.MIACode as MainMIOCODE,I.MIAName as MainMIONAME,C.Type as SpecialAmount FROM dbo.tblInvoice I WITH(nolock) INNER JOIN ( select InvoiceId,((Sum(TotalPrice)+Sum(TotalPriceVatAmount))-Sum(DiscountAmount))NetAmount,Sum(TotalPriceVatAmount)UnitVatAmount,(Sum(DiscountAmount))TotalPriceVatAmount from dbo.tblInvoiceDetail group by  InvoiceId) tblDetails ON I.InvoiceId = tblDetails.InvoiceId INNER JOIN dbo.tblCompanyUnit CU ON CU.ComUnitId = I.ComUnitId INNER JOIN View_CustomerMaster C ON C.CustomerMasterId = I.CustomerMasterId where I.TpTotal>0 AND I.DelivaryInvoiceNo IS NULL  and CU.ComUnitId='" + districtId.Trim() + "' and I.InvoiceDate between '" + fromDate + "' and '" + toDate + "' UNION ALL SELECT '" + fromDate + "' as fromdate ,'" + toDate + "' as todate ,CU.ComUnitCode,CU.ComUnitName,C.CustomerCode,C.CustomerName,I.OrderNo,CONVERT(VARCHAR,I.OrderDate,103) OrderDate,I.InvoiceNo, CONVERT(VARCHAR,I.InvoiceDate,103) InvoiceDate, I.TpGrandTotal AS NetAmount,I.TpVat AS TotalPriceVatAmount,I.TpDiscount AS DiscountAmount,I.AreaCode,I.RegionCode as MiaCode,I.DisCode AS DistrictCode ,I.MarketCode,I.MarketName,DATEDIFF(DAY,DATEADD(day, -1, InvoiceDate), GETDATE()) IntransitDay,I.MIACode as MainMIOCODE,I.MIAName as MainMIONAME,C.Type as SpecialAmount FROM dbo.tblSubInvoiceMaster I WITH(nolock) INNER JOIN dbo.tblCompanyUnit CU ON CU.ComUnitId = I.ComUnitId INNER JOIN View_CustomerMaster C ON C.CustomerMasterId = I.CustomerMasterId where I.TpTotal>0 AND I.DelivaryInvoiceNo IS NULL  and CU.ComUnitId='" + districtId.Trim() + "'  and I.InvoiceDate between '" + fromDate + "' and '" + toDate + "'";
        ...
        public DataTable LoadInvoicebyOrder(string orderno)
        {
            string query =
                       @"SELECT * FROM dbo.tblInvoice
                        ...
                        WHERE InvoiceId NOT IN (SELECT InvoiceId FROM dbo.tblReturnInvoice) AND (DelivaryInvoiceNo IS NOT NULL) and InvoiceNo='" + orderno + "'";
...
InvoiceNo='" + orderno + "'";
        ...
        {
            string insertQuery = @"INSERT INTO tblSalesReturnDetail
                                ( ProductId ,
                                  ProductCode ,
                                  ProductName ,
                                  Quantity ,
