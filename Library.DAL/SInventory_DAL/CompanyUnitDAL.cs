...
namespace Library.DAL.SInventory_DAL
{
    public class CompanyUnitDAL
    {
        ...
        {
            string query = @"UPDATE tblCompanyUnit SET ComUnitName='" + aCompanyUnit.ComUnitName + "',ComUnitCode='" + aCompanyUnit.ComUnitCode + "',Address='" + aCompanyUnit.Address + "',PhoneNo='" + aCompanyUnit.PhoneNo + "' WHERE ComUnitId=" + aCompanyUnit.ComUnitId + "";
