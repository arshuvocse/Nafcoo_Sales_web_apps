  ...
  public  class DoctorVisitDAL
    {
        ...
        public DataTable GetDCRReport(string param)
      {
          try
          {
              accessManager.SqlConnectionOpen(DataBase.SalesDB);
              ...
              DataTable dt = accessManager.GetDataTable("sp_DC_GetDCRReport", aSqlParameters);
              return dt;
        ...
        public DataTable GetWorkScheduleReport(string param)
      {
          try
          {
              accessManager.SqlConnectionOpen(DataBase.SalesDB);
              ...
              DataTable dt = accessManager.GetDataTable("sp_WS_GetWorkScheduleReport", aSqlParameters);
              return dt;
        ...
        public DataTable GetTwwpReport(string param)
      {
          try
          {
              accessManager.SqlConnectionOpen(DataBase.SalesDB);
              ...
              DataTable dt = accessManager.GetDataTable("sp_TWWP_GetTwwpReport", aSqlParameters);
              return dt;
