    ...
    public class RSMSetupDal
    {
        ...
        public ResultInfo Save_MBEInfo(MBEInfoDao aMIOInfo, int sessionUser)
        {
            ...
            try
            {
                ...
                gSqlParameterList.Add(new SqlParameter("@MBEInfoId", aMIOInfo.MBEInfoId));
                gSqlParameterList.Add(new SqlParameter("@SubTerritoryId", aMIOInfo.SubTerritoryId));
                ...
                gSqlParameterList.Add(new SqlParameter("@ActiveDate", aMIOInfo.ActiveDate));
        ...
        public DataTable Get_UserListInfo(string parameter)
        {
            try
            {
                ...
                List<SqlParameter> aSqlParameterlist = new List<SqlParameter>();
                aSqlParameterlist.Add(new SqlParameter("@Parameter", parameter));
                DataTable dt = accessManager.GetDataTable("sp_GET_UserList", aSqlParameterlist);
                return dt;
            }
            catch (Exception e)
            {
