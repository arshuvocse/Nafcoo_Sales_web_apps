    ...
    public class LeaveDal
    {
        ...
        public ResultInfo Save_LeaveInfo( EmployeeLeave employeeLeave, int sessionUser)
        {
            ...
            try
            {
                ...
                gSqlParameterList.Add(new SqlParameter("@MaxAllowDays", employeeLeave.MaxAllowDays));
                gSqlParameterList.Add(new SqlParameter("@IsHolidayCount", employeeLeave.IsHolidayCount));
