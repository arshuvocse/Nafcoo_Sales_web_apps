...
namespace SalesSolution.Web.DataLayer
{
    public class SeedDataDAL : iSeedData
    {
        ...
        public DataTable GetCustCategoryList()
        {
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SalesDB);
                List<SqlParameter> aSqlParameterlist = new List<SqlParameter>();
                DataTable dt = accessManager.GetDataTable("sp_GET_CustCategory");
                return dt;
            }
            catch (Exception e)
            {
        ...
        public int Save_TopSheetGenReportCodeInfo( string sessionUser)
        {
            int pk = 0;
        ...
        public DataTable GetChemistPriceGroup()
        {
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SalesDB);
                List<SqlParameter> aSqlParameterlist = new List<SqlParameter>();
                DataTable dt = accessManager.GetDataTable("sp_Get_CustomerPriceGroups");
                return dt;
            }
            catch (Exception e)
            {
        ...
        public DataTable GetPaymentTypeList()
        {
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SalesDB);
                List<SqlParameter> aSqlParameterlist = new List<SqlParameter>();
                DataTable dt = accessManager.GetDataTable("sp_GET_PaymentType");
                return dt;
            }
            catch (Exception e)
            {
