<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="UserSetupforEMP.aspx.cs" Inherits="MasterSetup_UI_UserSetupforEMP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        ...
                        <a href="../DoctorModule_UI/UserRecords.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
 ...
 <asp:HiddenField runat="server" ID="id_mastetID"/>
									...
									<li class="nav-item" role="presentation">
										<asp:LinkButton runat="server" ID="lbemp" CssClass="nav-link"   OnClick="lbemp_Click" >
											<div class="d-flex align-items-center">
												<div class="tab-icon"><i class=' bx bxs-user-pin font-18 me-1'></i>
												</div>
												<div class="tab-title">Employee Information</div>
											</div>
										</asp:LinkButton>
									</li>
									<li class="nav-item" role="presentation">
										<a CssClass="nav-link active" data-bs-toggle="pill" href="#primary-pills-home" role="tab" aria-selected="true">
											<div class="d-flex align-items-center">
												<div class="tab-icon"><i class='bx bxs-user font-18 me-1 '></i>
												</div>
												<div class="tab-title">User Setup</div>
											</div>
                                            
										</a>
									</li>
									<li class="nav-item" role="presentation">
										<a CssClass="nav-link" data-bs-toggle="pill" href="#primary-pills-contact" role="tab" aria-selected="false">
											<div class="d-flex align-items-center">
												<div class="tab-icon"><i class='bx bxs-map-pin font-18 me-1'></i>
												</div>
												<div class="tab-title">Market Access</div>
											</div>
										</a>
									</li>
								</ul>
