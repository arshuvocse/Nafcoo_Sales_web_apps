                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        ...
                                                        <span id="v-txtCampaignName" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span id="v-ddlChemistType" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                                        <span class="input-group-text text-c-red">*</span>
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                                                            Enabled="True" TargetControlID="txtProductQty" FilterType="Custom" ValidChars="0123456789.">
                                                        </asp:FilteredTextBoxExtender>
                                                        <span id="v-txtProductQty" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtenderunitValue" runat="server"
                                                            Enabled="True" TargetControlID="txtAmount" FilterType="Custom" ValidChars="0123456789.">
                                                        </asp:FilteredTextBoxExtender>
                                                        <span id="v-txtAmount" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                                            Enabled="True" TargetControlID="txtMaxAmount" FilterType="Custom" ValidChars="0123456789.">
                                                        </asp:FilteredTextBoxExtender>
                                                        <span id="v-txtMaxAmount" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        <asp:TextBox runat="server" ID="frmDate" type="datetime-local" class="form-control form-control-sm mb-3 " autocomplete="off" placeholder="Select Date"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                <label for="exampleInputUsername2" class="col-sm-6 col-form-label">&nbsp; </label>
                                                <br />
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                                            Enabled="True" TargetControlID="txtQtyList" FilterType="Custom" ValidChars="0123456789.">
                                                        </asp:FilteredTextBoxExtender>
                                                        <span id="v-txtQtyList" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                                        <span class="input-group-text text-c-red">*</span>
                                                        ...
                                                        <asp:GridView ID="gv_ProductOffer" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Remove">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="BtnProductOffer" runat="server" OnClick="BtnProductOffer_Click" CssClass="btn-danger  btn-sm mb-1 mb-md-0"><i class='fa fa-minus' aria-hidden='true'></i></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                   ...
                                   <%-- <h4>Customer List</h4>
                                    ...
                                    <div class="row" id="divCus" runat="server" Visible="False">
                                        <div class="col-2">&nbsp;</div>
                                        <div class="col-8">
                                            <div class="form-group row">
                                            ...
                                            <div class="table-responsive" id="MainGradeDivCustomer">
                                                ...
                                                <asp:GridView ID="gv_Customer" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Remove">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="deleteCustomer" runat="server" OnClick="deleteCustomer_Click" CssClass="btn-danger  btn-sm mb-1 mb-md-0"><i class='fa fa-minus' aria-hidden='true'></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label"></label>
                                                <div class="col-sm-8">
                                                    <asp:LinkButton OnClick="btnSave_Click" Visible="false" OnClientClick="return sweetAlertConfirm_Submit(this);" runat="server" ID="btnSave" class="btn btnMyDesignSearch   btn-sm"> <i class="fa fa-check"></i>Submit
                                                    </asp:LinkButton>
