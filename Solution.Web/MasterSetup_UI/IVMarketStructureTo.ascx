<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IVMarketStructureTo.ascx.cs" Inherits="MasterSetup_UI_IVMarketStructureTo" %>
...
<div style="padding-top:6px;"></div>
 ...
 <div class="form-group row" runat="server" visible="false">
                                    ...
                                    <label for="AreaSelect" class="col-sm-3 col-form-label">Distribution Center:  </label>

                                    <div class="col-sm-8">

                                         <div class="input-group">
                                               <asp:DropDownList ID="ddlDistributionCenter"  Enabled="false"  runat="server" CssClass="form-control form-control-sm mySelect2"
                                                                       >
                                                    </asp:DropDownList>

                                        <span id="v-ddlDistributionCenter" class="invalid-tooltip fade hide" data-delay="2000"></span>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                         ...
                                         <div class="input-group">
                                       <asp:DropDownList runat="server"    id="MarketSelect" AutoPostBack="true" OnSelectedIndexChanged="MarketSelect_SelectedIndexChanged"  class="form-select form-select-sm mb-3 mySelect2">  </asp:DropDownList>
 ...
 <div class="form-group row" runat="server" visible="false">
                                    ...
                                    <label for="AreaSelect" class="col-sm-3 col-form-label">Route:  </label>

                                    <div class="col-sm-8">

                                         <div class="input-group">
                                               <asp:DropDownList ID="rootDropDownList" Enabled="false" runat="server" CssClass="form-control form-control-sm mySelect2"
                                                                       >
                                                    </asp:DropDownList>

                                        <span id="v-rootDropDownList" class="invalid-tooltip fade hide" data-delay="2000"></span>
