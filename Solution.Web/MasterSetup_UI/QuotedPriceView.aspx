<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="QuotedPriceView.aspx.cs" Inherits="MasterSetup_UI_QuotedPriceView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Quoted Price List</div>
                                        ...
                                        <div class="row g-3 needs-validation">
                                            ...
                                            <div class="table-responsive" id="MainGradeDiv">
                                                ...
                                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                                    DataKeyNames="QuotedPriceMasterId"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<asp:BoundField DataField="MarketWise" HeaderText="Market Wise" />--%>

                                                        <asp:BoundField DataField="ActiveFromDate" HeaderText="Active From Date" DataFormatString="{0:dd-MMM-yyyy}" />
                                                        <asp:BoundField DataField="ActiveToDate" HeaderText="Active To Date" DataFormatString="{0:dd-MMM-yyyy}" />
