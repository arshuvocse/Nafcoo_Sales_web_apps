                                    ...
                                    <div class="table-responsive" id="MainGradeDiv">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="RegionCode" HeaderText="Cluster" />
                                                <asp:BoundField DataField="AreaCode" HeaderText="Region" />
                                                <asp:BoundField DataField="TerritoryCode" HeaderText="Area" />
                                                <asp:BoundField DataField="SubTerritoryCode" HeaderText="Territory" />
