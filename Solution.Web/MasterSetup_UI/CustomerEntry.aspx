...
<%@ Register TagPrefix="uc1" TagName="IVMarketStructure" Src="~/MasterSetup_UI/IVMarketStructureSearch.ascx" %>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtChemistName" placeholder=" Customer  Name"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row" runat="server"  visible="false">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlDistributionRoute"></asp:DropDownList>
                                             ...
                                             <div class="form-group row" runat="server"  >
                                                <label for="txtNID" class="col-sm-5 col-form-label">Customer Category:</label>

                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlCustomerCategory"></asp:DropDownList>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtEmail" placeholder=" Email Address"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtMobile" placeholder=" Mobile" MaxLength="11"></asp:TextBox>

                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                                            Enabled="True" TargetControlID="txtMobile" FilterType="Custom" ValidChars="0123456789">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtOwnerName" placeholder=" Owner Name"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " TextMode="MultiLine" Rows="1" runat="server" ID="txtAddress" placeholder=" Address"></asp:TextBox>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtVoterID" placeholder=" NID NO" MaxLength="17"></asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="FilnidteredTextBoxExtenderunitValue" runat="server"
                                                            Enabled="True" TargetControlID="txtVoterID" FilterType="Custom" ValidChars="0123456789">
                                                        </asp:FilteredTextBoxExtender>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtTradeLicense" placeholder=" Trade License"></asp:TextBox>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtDrugLicense" placeholder=" Drug License"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtPharmacyCouncilCertificate" placeholder=" Pharmacy Council Certificate"></asp:TextBox>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtBCDS" placeholder=" Drug License"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row" runat="server" visible="false">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlStationType"></asp:DropDownList>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                <label for="txtNID" class="col-sm-5 col-form-label">Payment Method:</label>

                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlPaymentMethod">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row" runat="server" visible="false">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlAMStationType"></asp:DropDownList>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row" runat="server" visible="false">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlDZSMStationType"></asp:DropDownList>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row" runat="server" visible="false">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlDistributionCenter"></asp:DropDownList>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group row" runat="server" visible="false">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-group">
                                                            <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlDivision" AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged"></asp:DropDownList>
                                                ...
                                                <div class="form-group row" runat="server" visible="false">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-group">
                                                            <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " AutoPostBack="true" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged" runat="server" ID="ddlDistrict"></asp:DropDownList>
                                                ...
                                                <div class="form-group row" runat="server" visible="false">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-group">
                                                            <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="ddlThana"></asp:DropDownList>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    <label for="chkIsActive" class="col-sm-4 col-form-label">&nbsp; </label>
                                                    <br />
                                        ...
                                        <div class="form-group row" style="margin-top: 6px;">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group" runat="server" visible="false">
                                                    ...
                                                    <span id="v-ShopImgUploadForm" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                                    <span class="input-group-text text-c-red">*</span>
                                                </div>
                                            ...
                                            <div class="col-sm-4" runat="server" visible="false">
                                                <div class="input-group">
                                                    ...
                                                    <span id="v-TradeLicenseimageUploadForm" class="invalid-tooltip fade hide" data-delay="2000"></span>
                                                    <span class="input-group-text text-c-red">*</span>
                                                </div>
