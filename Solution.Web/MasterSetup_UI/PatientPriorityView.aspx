<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="PatientPriorityView.aspx.cs" Inherits="MasterSetup_UI_WorkTypeView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Patient Priority List</div>
                                        ...
                                        <div class="row g-3 needs-validation">
                                            ...
                                            <div class="table-responsive" id="MainGradeDiv">
                                                ...
                                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                                    DataKeyNames="PatientPriorityId"
                                                    OnRowCommand="loadGridView_RowCommand" CssClass="table table-striped table-bordered" OnPreRender="gv_DocumentUpload_PreRender">
                                                    <Columns>
                                                        <asp:BoundField DataField="PatientStartPoint" HeaderText="Patient Start Point" />
                                                        <asp:BoundField DataField="PatientEndPoint" HeaderText="Patient End Point" />
                                                        <asp:BoundField DataField="RXStartPoint" HeaderText="RX Start Point" />
                                                        <asp:BoundField DataField="RXEndPoint" HeaderText="RX End Point" />
                                                        <asp:BoundField DataField="PatientStatus" HeaderText="Patient Status" />
                                                        <asp:BoundField DataField="PatientStatus" HeaderText="Patient Status" />
                                                        <asp:BoundField DataField="ColourCodeForNote" HeaderText="Colour Code For Note" />
