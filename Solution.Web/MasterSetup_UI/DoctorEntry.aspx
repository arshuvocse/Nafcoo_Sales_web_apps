                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox runat="server" class="form-control form-control-sm " ID="DoctorName" placeholder="Doctor name"></asp:TextBox>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList runat="server" ID="docCat" name="DoctorTypeSelect" class="form-select form-select-sm mb-3 mySelect2 "></asp:DropDownList>
                                            ...
                                            <div class="form-group row" runat="server" visible="false">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox runat="server" class="form-control form-control-sm " ID="SecondaryCode" placeholder="Secondary Code"></asp:TextBox>
                                    ...
                                    <div class="row" runat="server" visible="false">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox runat="server" class="form-control form-control-sm " ID="UPCode" placeholder="UP Code"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList class="form-select form-select-sm mb-3 mySelect2 " runat="server" ID="GenderSelect" name="GenderSelect">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList runat="server" AutoPostBack="true" OnSelectedIndexChanged="DoctorTypeSelect_SelectedIndexChanged" ID="DoctorTypeSelect" name="DoctorTypeSelect" class="form-select form-select-sm mb-3 mySelect2 "></asp:DropDownList>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row" runat="server" visible="false">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm mb-3 " runat="server" ID="txtUnion" placeholder=" Union Name"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList runat="server" ID="ChamberTypeSelect" name="ChamberTypeSelect" class="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox runat="server" class="form-control form-control-sm mb-3 " ID="txtChamberName" placeholder=" Chamber Name"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox runat="server" class="form-control form-control-sm mb-3 " ID="txtPhone" placeholder=" Chamber Phone"  MaxLength="11"></asp:TextBox>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox class="form-control form-control-sm mb-3 " TextMode="MultiLine" Rows="3" runat="server" ID="txtChamberAddress" placeholder="Chamber Address"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList runat="server" ID="ddlContactType" name="ChamberTypeSelect" class="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox runat="server" class="form-control form-control-sm mb-3 " ID="txtContact" placeholder=" Contact"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList runat="server" ID="ddlSpecialDay" name="ddlSpecialDay" class="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox runat="server" class="form-control form-control-sm mb-3 datepicker" ID="txtSpecialDate" placeholder="Select Special Date"></asp:TextBox>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox Visible="false" class="form-control form-control-sm mb-3 datepicker" runat="server" ID="txtActiveDate" placeholder=" Select Date"></asp:TextBox>
