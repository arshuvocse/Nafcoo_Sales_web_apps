<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeSetup.aspx.cs" Inherits="MasterSetup_UI_EmployeeSetup" %>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label class="col-form-label">
                                                    <asp:CheckBox runat="server" ID="chkIsTempEmployeeCode" Text="Is Temp Employee Code" />
                                                </label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                                    Enabled="True" TargetControlID="txtEmergencyContactNo" FilterType="Custom" ValidChars="0123456789">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <asp:FilteredTextBoxExtender ID="FilnidteredTextBoxExtenderunitValue" runat="server"
                                                    Enabled="True" TargetControlID="txtNIDNO" FilterType="Custom" ValidChars="0123456789">
                                                </asp:FilteredTextBoxExtender>
                                            </div>
                                        </div>
                                        <!-- Col -->
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                                    Enabled="True" TargetControlID="txtEmpContactNo" FilterType="Custom" ValidChars="0123456789">
                                                </asp:FilteredTextBoxExtender>
                                            </div>
                                        </div>
                                        <!-- Col -->
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                                                    Enabled="True" TargetControlID="ReferenceContactNo" FilterType="Custom" ValidChars="0123456789">
                                                </asp:FilteredTextBoxExtender>
                                            </div>
                                        </div>
                                        <!-- Col -->
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-7">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <asp:DropDownList runat="server" class="form-select form-select-sm mb-3 mySelect2" ID="ddlUserRole"></asp:DropDownList>
                                                        ...
                                                        <span class="input-group-text text_Link">
                                                            <asp:LinkButton runat="server" ID="loadUserRole" OnClick="loadUserRole_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                        <span class="input-group-text text-c-red">*</span>
                                                    </div>
                                                </div>
