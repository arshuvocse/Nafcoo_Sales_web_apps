          ...
          <div class="col-md-4 card border-top border-0 border-4 border-primary" >
            ...
            <ContentTemplate>--%>
                ...
                <ul class="nav">
                    ...
                    <style>hr.new5 {
  border: 10px solid #90DFAA;
  border-radius: 5px;
}</style>
                    <hr  class="new5" />
                     <div class="form-group">
                                        <label class="col-form-label">Old Password</label>
                                        <asp:Label runat="server" AutoCompleteType="None" ID="lblOldPassword" class="form-control form-control-sm"></asp:Label>
                                    </div>
                                        ...
                                        <asp:TextBox runat="server"  AutoCompleteType="None" ID="txtConfirm" class="form-control form-control-sm"></asp:TextBox>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <asp:LinkButton runat="server" ID="btn_Save" OnClick="btn_Save_OnClick" CssClass="btn btnMyDesignSearch   btn-sm btn-block" OnClientClick="return sweetAlertConfirm_Update(this);"  >  <i class="fa fa-check"></i> Update Password
