...
public partial class SInventory_RPTVIEW_DCStockReportViewer : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        int rpt = Convert.ToInt32(Session["ReportView"]);
            ...
            if (ComUnitId != "")
            {
                comUnitDetailDataTable = aDcStockReportBll.DCReportDetailDataDALDtls((ComUnitId)).Copy();
            }
            if (ComUnitId == "")
            {
                comUnitDetailDataTable = aDcStockReportBll.DCReportDetailDataDALDtls("").Copy();
            }
