...
public partial class SInventory_RPTVIEW_DeleteInvoiceReportViewer : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (rptType == "1")
        {
            ...
            mainDataTable.TableName = "dsDeleteInvoiceReportDataTable";
        ...
        if (excel == "N")
        {
            rptdoc.Load(ReportPath("crpDeleteInvoiceReport.rpt"));
