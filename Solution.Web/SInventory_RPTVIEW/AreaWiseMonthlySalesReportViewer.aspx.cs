...
public partial class SInventory_RPTVIEW_AreaWiseMonthlySalesReportViewer : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        {
            mainDataTable = aReportBll.LoadAreaWiseMonthlyInventoryNationalReport(fromDate, toDate).Copy();
        } 
        ...
        rptdoc.Load(ReportPath("rptAreaWiseMonthlyInventoryReport.rpt"));
