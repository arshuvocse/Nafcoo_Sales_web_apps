<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="Territory_Transfer.aspx.cs" Inherits="TransferUI_Territory_Transfer" %>


<%@ Register Src="~/TransferUI/IVMarketStructureFrom_ToTeriiTransfer.ascx" TagPrefix="uc1" TagName="IVMarketStructure" %> 
<%@ Register Src="~/TransferUI/IVMarketStructureFrom_ToTeriiTransfer.ascx" TagPrefix="uc1" TagName="IVMarketStructureTo" %> 
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Area Transfer</div>
                                       ...
                                       <div class="col-12">
                                                 ...
                                                 <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="Label_Title">Area List</div>
