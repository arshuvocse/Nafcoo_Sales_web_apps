<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IVMarketStructureFrom_ToTeriiTransfer.ascx.cs" Inherits="TransferUI_IVMarketStructureFrom_ToTeriiTransfer" %>
