<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="MarketInfoApprove.aspx.cs" Inherits="TransferUI_MarketInfoApprove" %>
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Market Creation Approval</div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                              <asp:HiddenField runat="server" ID="hfCustPropMasterId" Value='<%#Eval("MarketPropMasterId")%>' />
