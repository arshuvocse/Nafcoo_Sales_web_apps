<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DoctorImport.aspx.cs" Inherits="TransferUI_DoctorImport" %>
     ...
     <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Doctor Updation </div>
            ...
            <div class="row">
                <div class="col">
                  ...
                  <asp:RadioButtonList runat="server" ID="rbType" CssClass="radioChoice"   RepeatDirection="Horizontal" RepeatLayout="Flow">
                      ...
                      <asp:ListItem Value="Customer Type">Doctor Type Update</asp:ListItem>
                            ...
                            <div class="row">
                               <div class="col-md-2"><a href="../ExcelFiles/DoctorFormat.xls"  class="btn  btn-secondary   btn-sm">Download Excel Format</a>  </div>
                                   <div class="col-md-10">
                ...
                <div class="table-responsive" id="MainGradeDiv">
                     ...
                     <asp:GridView ID="productGridView" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Doctor Code">
                                <ItemTemplate>
                                    <asp:Label ID="lblCustomerCode" runat="server"  CssClass="form-control form-control-sm" 
                                          Text='<%# Eval("DoctorCode")%>'  ></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Doctor Type Code">
                                <ItemTemplate>
                                   <asp:Label ID="lblCustomerTypeCode" runat="server" CssClass="form-control form-control-sm"   Text='<%# Eval("DoctorTypeCode")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
