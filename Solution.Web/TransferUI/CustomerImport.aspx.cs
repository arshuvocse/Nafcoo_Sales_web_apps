...
public partial class TransferUI_CustomerImport : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("CustomerProviderTypeApprove.aspx");
    }
    ...
    private void InitialGrid()
    {
        ...
        aDataTable.Columns.Add("CustomerTypeCode");
...

   {
    ...
    protected void submitButton_Click(object sender, EventArgs e)
    {
        if (Validation())
        {
            ...
            ResultInfo Res = _BonusCampaignNewDAL.SaveCustomerInfoForExcel(aMaster, DtlList,  Session["UserId"].ToString());
            if (Res.isSuccess == true)
            {


                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "successalert('" + "Operation successful!" + "','Success','CustomerImport.aspx');", true);
