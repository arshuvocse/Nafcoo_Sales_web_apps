                            ...
                            <div class="card" style="border-right: 1px solid #3C8BCA">
                                ...
                                <div class="card-body" style="height: 300px !important;">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <h5 class="card-title text-success d-none" style="text-transform: capitalize !important; font-size: 1.2em !important;">
    ...
    <script>
        ...
        function SaveLeaveApplication() {
            ...
            if (FormValidation()) {
                ...
                jsonData["StartDate"] = $('#leaveFromDate').val();
        ...
        function LoadLeaveType() {
            var urlpath = 'LeaveApplicationCode.aspx/GetLeaveType';
            ...
            $.ajax({
                ...
                data: '{}',
                success: function (data) {
                    var result = typeof data.d === "string" ? JSON.parse(data.d) : data.d;

                    $('#ddlLeaveType').empty().append("<option value='0'>--Select Leave Type--</option>");
                    for (var i = 0; i < result.length; i++) {
                        $('#ddlLeaveType').append(
                            $("<option></option>").val(result[i].LeaveTypeId).html(result[i].LeaveTypeName)
                        );
                    }
                }
            });
