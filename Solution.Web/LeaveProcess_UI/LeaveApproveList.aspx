<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="LeaveApproveList.aspx.cs" Inherits="Approval_UI_LeaveApproveList" %>
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Leave Approval List</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="align-content:center">
                               ...
                               <asp:LinkButton  runat="server" class="btn btnMyDesignReset   btn-sm"   id="resetBtn" onclick="resetBtn_Click" ><i class="fa fa-retweet" aria-hidden="true"></i>&nbsp; Reset </asp:LinkButton>
                                ...
                                DataKeyNames="TableId,LeaveApprovalId,FromEmpId,ToEmpId,Step,RoleTypeId,ToRoleTypeId,MaxStep"   onrowcommand="loadGridView_RowCommand"    
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LeaveFromDate" HeaderText="Leave From-To Date" />
                                    
                                    <%--<asp:BoundField DataField="LeaveTypeName" HeaderText="Leave Type" />--%>
                                    <asp:BoundField DataField="DateOfReturnsToDuty" HeaderText="Date Of Returns To Duty" />
                                  ...
                                  <%--  <asp:BoundField DataField="DesigName" HeaderText="Designation" />
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                              ...
                                              <asp:HiddenField runat="server" ID="hfCustomerApprovalId" Value='<%#Eval("LeaveApprovalId")%>' />
                                             ...
                                             <asp:Label runat="server" ID="lbMsg"   />
                                              <asp:LinkButton ID="lbEdit" Visible="false" runat="server" class="btn-warning  btn-sm mb-1 mb-md-0"
                                               ...
                                               <asp:LinkButton ID="lbApprove"  Enabled='<%# Eval("ApprovalStatusWeb").ToString() != "Rejected" && Eval("ApprovalStatusWeb").ToString() != "Approved" %>' runat="server" CssClass="btn-info  btn-sm mb-1 mb-md-0"
                                                                     CommandArgument="<%# Container.DataItemIndex %>" CommandName="ApproveData"><i class='fa fa-check' aria-hidden='true'></i></asp:LinkButton>
                                            
                                            
                                               <asp:LinkButton ID="lbReject"  Enabled='<%# Eval("ApprovalStatusWeb").ToString() != "Rejected" && Eval("ApprovalStatusWeb").ToString() != "Approved" %>' runat="server" CssClass="btn-danger  btn-sm mb-1 mb-md-0"
                                                                    CommandArgument="<%# Container.DataItemIndex %>" CommandName="RejectData"> <i class='fadeIn animated bx bx-x' aria-hidden='true'></i> </asp:LinkButton>
