...
public partial class Approval_UI_LeaveApproveList : System.Web.UI.Page
{
    ...
    private void LoadInitialInfo()
    {
        ...
        try
        {
            using (DataTable dt = _seedRepo.GetApprovalStatusList())
            {
                ...
                ApprovalStatusSelect.SelectedValue = "0";
            }
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ApproveData")
        {
            ...
            LeaveApplo_Save aMaster = new LeaveApplo_Save();
            aMaster.LeaveApprovalId = hfCustomerApprovalId.Value == "" ? 0 : Convert.ToInt32(hfCustomerApprovalId.Value);
            ...
            aMaster.MenuId = 381;
            ResultInfo Res = _DAL.SaveLeave_ApplogDAL(aMaster);
    ...
    private void LoadData()
    {
        ...
        if (EmpInfoId != "" || EmpInfoId != null)
        {
            ...
            switch (RoleTypeName)
            {
                case "AM":
                    ...
                    param = " AND View_Webapi_EmployeeFieldForceInfo.EmpAreaId=" + FFID ;
                    Role = "AM";
                    break;

                case "DZSM":
                    FFID = dtMarket.Rows[0]["EmpRegionId"].ToString();
                    param = " AND  View_Webapi_EmployeeFieldForceInfo.EmpRegionId=" + FFID;
                    Role = "DZSM";
                    break;
                case "NSM":
                    FFID = dtMarket.Rows[0]["EmpGroupId"].ToString();
                    param = " AND  View_Webapi_EmployeeFieldForceInfo.EmpGroupId=" + FFID;
                    Role = "NSM";
                    break;
        ...
        {
            param = param + " AND CONVERT(date,Employee_LeaveApplications.EntryDate)  BETWEEN '" + FromDate.Text + "' AND '" + ToDate.Text + "' ";
        }
        if (FromDate.Text != "" && ToDate.Text == "")
        {
            param = param + " AND CONVERT(date,Employee_LeaveApplications.EntryDate)  BETWEEN '" + FromDate.Text + "' AND '" + DateTime.Now.ToString("dd-MMM-yyyy") + "' ";
        }
        ...
        if (ApprovalStatusSelect.SelectedValue != "")
        {
            ...
            param = param + " AND Employee_LeaveApplications.ApprovalStatus='" + ApprovalStatusSelect.SelectedValue + "'";
        ...
        if (EmployeeIdSelect.SelectedValue != "")
        {
            ...
            param = param + " AND Employee_LeaveApplications.EmployeeId ='" + EmployeeIdSelect.SelectedValue + "'";
        ...
        DataTable aDataTable = _DAL.GetLeave_AppLogDAL(param, Role, AppStatus, FromDt, ToDt, EmpId);
