...
public partial class Approval_UI_RXApprovalList : System.Web.UI.Page
{
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ApproveData")
        {
            ...
            aMaster.MenuId = 379;
            ResultInfo Res = _DAL.SaveRX_Applog_DAL(aMaster);
    ...
    private void LoadData()
    {
        ...
        {
            pram = pram + " AND CONVERT(date,tbl_PrescriptionMaster.EntryDate)  BETWEEN '" + FromDate.Text + "' AND '" + ToDate.Text + "' ";
        }
        if (FromDate.Text != "" && ToDate.Text == "")
        {
            pram = pram + " AND CONVERT(date,tbl_PrescriptionMaster.EntryDate)  BETWEEN '" + FromDate.Text + "' AND '" + DateTime.Now.ToString("dd-MMM-yyyy") + "' ";
        }
        ...
        if (ApprovalStatusSelect.SelectedValue != "")
        {
            ...
            pram = pram + " AND tbl_PrescriptionMaster.ApprovalStatus='" + ApprovalStatusSelect.SelectedValue + "'";
        ...
        if (EmployeeIdSelect.SelectedValue != "")
        {
            ...
            pram = pram + " AND tblEmpGeneralInfo.EmpInfoId='" + EmployeeIdSelect.SelectedValue + "'";
        ...
        DataTable aDataTable = _DAL.GetRX_Applog(pram, Role, AppStatus, FromDt, ToDt, EmpId);
    ...
    {
        Response.Redirect("RXApprovalList.aspx");
    }
}