...
public partial class Approval_UI_DoctorCustomerTransferApproval : System.Web.UI.Page
{
    ...
    protected void rbType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rbType.Items[0].Selected)
            {
                ...
                DataTable aDataTable = _CustomerInfoDAL.GetCustomerTranferList("");
                gv_Customer_List.DataSource = aDataTable;
                gv_Customer_List.DataBind();
            }
            else
            {
                DataTable aDataTable = _DoctorDAL.GetDoctorTransferList("");
    ...
    private void DcStockOutViewForApproval()
    {
        ...
        DataTable dt = aStockOutBll.DcStockOutAppBll();
    ...
    protected void btnSubmit0_Click(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            Res = _CustomerInfoDAL.UpdateCustomer_Doctor_TransferApprove(Type, EmpIdAA, "", HttpContext.Current.Session["UserId"].ToString(), "", "");
    ...
    private void SubmitApproval()
    {
        ...
        if (statusRadioButtonList.SelectedItem.Text != "Reject")
        {
            ...
            ShowMessageBox("Stock Adjustment Approved Successfully!!");
        }
