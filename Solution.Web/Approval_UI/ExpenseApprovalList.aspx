<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ExpenseApprovalList.aspx.cs" Inherits="Approval_UI_ExpenseApprovalList" %>
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Expense Approval List</div>
...
<br />        
                        ...
                        <div style="padding-top:10px;"></div>
                                ...
                                DataKeyNames="TableId,ExpanseApprovalId,FromEmpId,ToEmpId,Step,RoleTypeId,ToRoleTypeId,MaxStep"   onrowcommand="loadGridView_RowCommand"    
            ...
            class="fancybox "  >
                                    ...
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                              ...
                                              <asp:HiddenField runat="server" ID="hfCustomerApprovalId" Value='<%#Eval("ExpanseApprovalId")%>' />
