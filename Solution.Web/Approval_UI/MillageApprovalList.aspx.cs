...
public partial class Approval_UI_MillageApprovalList : System.Web.UI.Page
{
    ...
    protected void loadGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "ApproveData")
        {
            ...
            aMaster.MenuId = 372;
            ResultInfo Res = _DAL.SaveMileageClaim_Applog_DAL(aMaster);
    ...
    private void LoadData()
    {
        ...
        {
            pram = pram + " AND CONVERT(date,tbl_MileageClaim.MileageDate)  BETWEEN '" + FromDate.Text + "' AND '" + ToDate.Text + "' ";
        }
        if (FromDate.Text != "" && ToDate.Text == "")
        {
            pram = pram + " AND CONVERT(date,tbl_MileageClaim.MileageDate)  BETWEEN '" + FromDate.Text + "' AND '" + DateTime.Now.ToString("dd-MMM-yyyy") + "' ";
        }
        ...
        if (ApprovalStatusSelect.SelectedValue != "")
        {
            ...
            pram = pram + " AND tbl_MileageClaim.ApprovalStatus='" + ApprovalStatusSelect.SelectedValue + "'";
        ...
        if (EmployeeIdSelect.SelectedValue != "")
        {
            ...
            pram = pram + " AND tbl_MileageClaim.EmpInfoId='" + EmployeeIdSelect.SelectedValue + "'";
        ...
        DataTable aDataTable = _DAL.GetMileageClaim_Applog(pram, Role, AppStatus, FromDt, ToDt, EmpId);
    ...
    {
        Response.Redirect("MillageApprovalList.aspx");
    }
}