...
public partial class SInventory_UI_TotalSummaryNew2 : System.Web.UI.Page
{
    ...
    private void LoadInfo()
    {
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            aDataTable = aSummaryBll.LoadSummaryProductcodewiseGyash(Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()), Type);
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
        if (loadGridView.Rows.Count > 0)
        {
            ...
            string attachment = "attachment; filename=BusinessSummary_List_" + DateTime.Now.ToString("dd_MMM_yyyy_hh_mm_tt") + ".xls";
            ...
            string headerTable = @"<span  style='text-align:center'><h3>  Business Summary Report  (Date Range : " + fromDateTextBox.Text + "- " + toDateTextBox.Text + ") </h3>  </span> <span   style='text-align:right'><h4> Print Date: " + DateTime.Now.ToString("MMMM dd, yyyy") + "</h4></span>";
