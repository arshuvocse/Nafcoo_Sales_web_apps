<%@ Page Title="Product Information List" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ProductView.aspx.cs" Inherits="SInventory_UI_ProductView" %>
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Product Information  List</div>
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                        <div class="card-body">
                            ...
                            DataKeyNames="ProductId" 
                                ...
                                <Columns>
                                    <asp:BoundField DataField="GenericGroupName" HeaderText="Generic Group" />
