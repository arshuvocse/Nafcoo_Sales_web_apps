...
public partial class SInventory_UI_DeleteInvoiceReport : System.Web.UI.Page
{
    DeleteInvoiceReportBLL aOrderReportBll = new DeleteInvoiceReportBLL();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            nationalCheckBox_OnCheckedChanged(null, null);
        }
    }
    ...
    private void Popup()
    {
        ...
        string url = "../SInventory_RPTVIEW/DeleteInvoiceReportViewer.aspx?rptType=" + rptType;
    ...
    private string GenerateParameter()
    {
        ...
        if (comUnitNameDropDownList.Text != "")
        {
            ...
            {
                parameter = parameter + " and  com.ComUnitCode = '" + comUnitNameDropDownList.Text.Trim() +
                            "' AND mas.DeleteDateTime BETWEEN '" + fromDateTextBox.Text.Trim() + "' AND '" +
                            toDateTextBox.Text.Trim() + "'    ";
            }
        ...
        if (comUnitNameDropDownList.Text == "")
        {
            if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
            {
                parameter = parameter + " AND mas.DeleteDateTime BETWEEN '" + fromDateTextBox.Text.Trim() + "' AND'" +
                            toDateTextBox.Text.Trim() + "'   ";
            }
            else
            {
