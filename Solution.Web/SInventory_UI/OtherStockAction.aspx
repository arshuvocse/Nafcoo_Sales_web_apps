                                            ...
                                            <div class="col-8">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <asp:LinkButton ID="submitButton" CssClass="btn btn-sm btn-primary mb-2" runat="server" OnClick="submitButton_Click" Style="background-color: #00bcd4; color: #fff;"><i class="fa fa-search-plus"></i>&nbsp; Search Information</asp:LinkButton>


                                                        <asp:LinkButton ID="submitButton0" CssClass="btn btn-sm btn-primary mb-2" runat="server" OnClick="submitButton0_OnClick" Style="background-color: #00bcd4; color: #fff;"><i class="fa fa-check-square"></i>&nbsp; Submit Information</asp:LinkButton>
