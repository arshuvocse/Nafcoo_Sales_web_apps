                       ...
                       <div class="row">
                         ...
                         <asp:TextBox ID="custCodeTextBox" runat="server" AutoPostBack="True" CssClass="form-control form-control-sm"
                                ...
                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server"
                                   ...
                                   <div class="form-group row" >
                                    <label for="" class="col-sm-3 col-form-label">  Customer Address :</label>
                                  ...
                                  <div class="form-group row"  runat="server" visible="false">
                                    <label for="" class="col-sm-3 col-form-label">  MIO Name :</label>
                                ...
                                <div class="form-group row" >
                                    <label for="" class="col-sm-3 col-form-label">Fixed Business Customer:</label>
                           ...
                           <div class="col-md-6">
                                   ...
                                   <div class="form-group row" runat="server" visible="false">
                                    <label for="mainName" class="col-sm-3 col-form-label"> FE Name :</label>
                                   ...
                                   <div class="form-group row"  runat="server" visible="false">
                                    <label for="mainName" class="col-sm-3 col-form-label"> Customer Category Name :</label>
                            ...
                            <div class="col-md-6">
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                          ...
                                          <asp:TextBox ID="tbxSalesCenter" runat="server" CssClass="form-control form-control-sm" ReadOnly="True"></asp:TextBox>
