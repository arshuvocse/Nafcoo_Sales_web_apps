                                    ...
                                    <div class="row">
                                        ...
                                        <div class="table-responsive" id="MainGradeDiv">
                                            ...
                                            <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered  text-center thead-dark"
                                                DataKeyNames="DCStoreId,ProductCode,ProductName,TotalQuantity,StockQty">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Mfg. Date">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="mfgDateTextBox" runat="server" Text='<%# Eval("MfgDate")%>' CssClass="form-control form-control-sm mb-3 datepicker"></asp:TextBox>
                                                    ...
                                                    <asp:BoundField DataField="TotalQuantity" HeaderText="Receive Qty" />
                                                    <asp:BoundField DataField="StockQty" HeaderText="Avilable Qty" />
                                                    ...
                                                    <%-- <asp:BoundField DataField="StockQty" HeaderText="C.Stock Qty" />--%>
                                                     ...
                                                     <asp:TemplateField HeaderText="Spilt">
                                                                <ItemTemplate>
