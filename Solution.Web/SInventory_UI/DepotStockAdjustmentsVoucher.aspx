...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style type="text/css">
        ...
        #ContentPlaceHolder1_rdoDusDoc_0,
        #ContentPlaceHolder1_rdoDusDoc_1 {
            margin-right: 4px !important;
            margin-left: 2px !important;
        }


        #ContentPlaceHolder1_rdoInvoiceType_0,
        #ContentPlaceHolder1_rdoInvoiceType_1,
        #ContentPlaceHolder1_rdoInvoiceType_2,
        #ContentPlaceHolder1_rdoInvoiceType_3 {
            margin-right: 4px !important;
            margin-left: 2px !important;
        }
    </style>
                        ...
                        <div class="col">
                            ...
                            <div class="card border-top border-0 border-4 border-success">
                                            ...
                                            <div class="col-8">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        ...
                                                        <asp:RadioButtonList runat="server" ID="rdoDusDoc" RepeatColumns="2" TextAlign="Right" RepeatLayout="Flow" RepeatDirection="Horizontal" AutoPostBack="True"
                                                            OnSelectedIndexChanged="rdoDusDoc_OnSelectedIndexChanged">
                                                            <asp:ListItem Value="Cus">
                                                Customer
                                                            </asp:ListItem>
                                                ...
                                                <div runat="server" id="Cust" visible="False">
                                                ...
                                                <div runat="server" id="Doct" visible="False">



                                                    <div class="form-group row">
                                                        <label for="mainName" class="col-sm-3 col-form-label">Doctor Code :</label>

                                                        <div class="col-sm-5">
                                                            <span style='color: gray; font-size: 10px;'>(Please input ‘N/A’ if no Doctor)</span>
                                                            <asp:TextBox ID="txtDoctor" runat="server" CssClass="form-control form-control-sm">
                                                            </asp:TextBox>
                                ...
                                TargetControlID="StockOutTextBox">
                                                ...
                                                <div class="form-group row">
                                                    <label for="mainName" class="col-sm-3 col-form-label">Invoice Type:</label>
                                                    <div class="col-sm-5" style="padding-top: 8px">
                                                        <asp:TextBox ID="txtReason" runat="server" Visible="False" CssClass="form-control form-control-sm"></asp:TextBox>

                                                        <asp:RadioButtonList runat="server" ID="rdoInvoiceType" RepeatColumns="3" TextAlign="Right" RepeatLayout="Flow" RepeatDirection="Horizontal">
                                                        </asp:RadioButtonList>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive" id="MainGrasdeDiv">
                                                ...
                                                <asp:GridView ID="DerectStoctOutGridView" runat="server" AutoGenerateColumns="False"
                                                    CssClass="table  blueTable" OnPreRender="gv_DocumentUpload_PreRender" DataKeyNames="DCStoreId,PackSize,VATAmountPerUnit,UnitPrice">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                            ...
                                            <div class="table-responsive" id="MainGradeDiv">
                                                ...
                                                <asp:GridView ID="chalanGridView" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Unit Vat">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_UnitVat" runat="server" Text='<%#Eval("UnitVat") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Total Unit Price">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_TotalUnitPrice" runat="server" Text='<%#Eval("TotalUnitPrice") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Total Unit Vat">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_TotalUnitVat" runat="server" Text='<%#Eval("TotalUnitVat") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Total Price">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_TotalPrice" runat="server" Text='<%#Eval("TotalPrice") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
