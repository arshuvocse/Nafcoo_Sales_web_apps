<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="QuotedPriceReport.aspx.cs" Inherits="SInventory_UI_QuotedPriceReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Quoted Price Report</div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <asp:DropDownList ID="ddlCustomer" runat="server" CssClass="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                                </div>
