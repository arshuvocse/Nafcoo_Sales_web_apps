<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TargetReport.aspx.cs" Inherits="SInventory_UI_ProformaReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Target Report</div>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                 ...
                                                 <asp:BoundField DataField="CLS" HeaderText="CLS" />
                                                 ...
                                                 <asp:BoundField DataField="TargetValueByTp" HeaderText="Target (TP)" />
                                                 <asp:BoundField DataField="VatPerPack" HeaderText="VAT/Pack" />
                                                 <asp:BoundField DataField="TargetValueByTpVat" HeaderText="Target (TP+VAT)" />
