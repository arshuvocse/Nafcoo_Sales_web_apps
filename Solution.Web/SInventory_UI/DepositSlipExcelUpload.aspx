            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                                           ...
                                           <a href="CompanyWiseBranch.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                   ...
                                   <div class="form-group row">
                                    <label for="mainName" class="col-sm-3 col-form-label"> Select File :</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="form-group row">
                                  ...
                                  <asp:LinkButton ID="LinkButton2" CssClass="btn btn-sm btn-primary mb-2" runat="server" OnClick="btnUpload_Click" style="background-color: #00bcd4;color: #fff;">   <i class="fa fa-upload"></i>&nbsp; Upload</asp:LinkButton>
