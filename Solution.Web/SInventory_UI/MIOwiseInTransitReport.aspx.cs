...
public partial class SInventory_UI_MIOwiseInTransitReport : System.Web.UI.Page
{
    ...
    private string Parm()
    {
        ...
        else
        {
            ...
            {
                param = param + " AND ord.ComUnitId='" + dcDropDownList1.SelectedValue + "' ";
            }
        }
        if (mioDropDownList.SelectedValue != "")
        {
            param = param + " AND ord.MIOId='" + mioDropDownList.SelectedValue + "' ";
        }


        if (marketDropDownList.SelectedValue != "")
        {
            param = param + " AND ord.TerritoryId='" + marketDropDownList.SelectedValue + "' ";
        }
