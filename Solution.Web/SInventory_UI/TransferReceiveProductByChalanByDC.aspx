<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TransferReceiveProductByChalanByDC.aspx.cs" Inherits="SInventory_UI_ReceiveProductByChalanByDC" %>
                    ...
                    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
                                ...
                                <a href="TransferStockReceiveByDC.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                                ...
                                <div class="row">
                                    <div class="table-responsive" id="MainGradeDiv">
                                        <asp:GridView ID="rcvGridView" runat="server" AutoGenerateColumns="False"
                                            CssClass="table table-bordered  text-center thead-dark" DataKeyNames="ChalanId,ChalanDetailsId,DCStoreId" OnPreRender="gv_DocumentUpload_PreRender">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ExpDate" DataFormatString="{0:dd-MMM-yyyy}"
                                                    HeaderText="Exp Date" />
                                                <asp:BoundField DataField="ReceiveDate2" DataFormatString="{0:dd-MMM-yyyy}"
                                                ...
                                                <asp:TemplateField HeaderText="Rcv Qty">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                                            Enabled="True" TargetControlID="rcvQtyTextBox" FilterType="Custom" ValidChars="0123456789.">
                                                        </asp:FilteredTextBoxExtender>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Un Rcv Qty">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="damageTextBox" CssClass="form-control form-control-sm mb-3 " runat="server" AutoPostBack="True"
                                                            OnTextChanged="damageTextBox_TextChanged">0</asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="FilteredTexstBoxExtender3" runat="server"
                                                            Enabled="True" TargetControlID="damageTextBox" FilterType="Custom" ValidChars="0123456789.">
                                                        </asp:FilteredTextBoxExtender>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="form-group row" style="text-align: center">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <asp:LinkButton  
                                                    OnClientClick="return confirm('Are you aware of this operation?');" 
                                                    OnClick="submitButton_Click" 
                                                    runat="server" 
                                                    ID="submitButton" 
                                                    class="btn btnMyDesignSearch btn-sm">
