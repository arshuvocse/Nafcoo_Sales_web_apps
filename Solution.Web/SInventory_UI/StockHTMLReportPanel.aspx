<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master"
    AutoEventWireup="true" CodeFile="StockHTMLReportPanel.aspx.cs" Inherits="SInventory_UI_AreaWiseMonthlyInventoryReport" %>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                         ...
                                         <%--       <asp:BoundField DataField="ComUnitCode" HeaderText="Branch Code"></asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="TotalStockReceiveQty" HeaderText="Received Quantity" />
                                                ...
                                                <asp:BoundField DataField="DcFreeze" HeaderText="QI/Freeze Quantity" />
...
<%--                                                <asp:BoundField DataField="ComUnitCode" HeaderText="Branch Code"></asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="OpeningQuantity" HeaderText="Opening Quantity" />
                                                <asp:BoundField DataField="ReceivedQuantity" HeaderText="Received Quantity" />
                                                <asp:BoundField DataField="MarketReturn" HeaderText="Market Return" />
                                                <asp:BoundField DataField="B2BChallan" HeaderText="B2B Challan" />
                                                
                                                
                                                <asp:BoundField DataField="DeliveredQty" HeaderText="Delivered Qty" />
                                                <asp:BoundField DataField="FreezQty" HeaderText="Freez Qty" />
                                                <asp:BoundField DataField="Foc" HeaderText="Foc" />
                                                
                                                
                                                <asp:BoundField DataField="ReturntoWH" HeaderText="Return to WH" />
                                                <asp:BoundField DataField="BookForDelivery" HeaderText="Book For Delivery" />
