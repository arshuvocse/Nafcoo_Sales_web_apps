<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="StockHTMLReportPanelNew.aspx.cs" Inherits="SInventory_UI_StockHTMLReportPanelNew" %>
                ...
                <div class="col">
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                     ...
                     <div class="col-3" >
                          ...
                          <div class="form-group row  pull-right">
                                                <asp:LinkButton ID="LinkButton1" class="btn btn-sm   mb-2" style="background-color: #1A7343; color: #fff;" runat="server" OnClick="ddviewRptButton_Click"
                                                ><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp; Download Batch wise current stock report </asp:LinkButton>
                                               ...
                                               <asp:BoundField DataField="ComUnitCode" HeaderText="Branch Code"></asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="TransferedOutQty" HeaderText="Transfered Out Qty" />
                                                  <asp:BoundField DataField="SoldQty" HeaderText="Sold Qty" />
                                                      <asp:BoundField DataField="FocOrSample" HeaderText="Sample Qty" />
                                                ...
                                                <asp:BoundField DataField="MarketReturn" HeaderText="Market Return" />
                                                   <asp:BoundField DataField="FrezeStock" HeaderText="Freeze Qty" />
                                                <asp:BoundField DataField="ClosingStock" HeaderText="Closing Qty" />
