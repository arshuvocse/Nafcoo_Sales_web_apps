...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
                                ...
                                <asp:LinkButton ID="ListImageButton" CssClass="btn btn-sm btn-outline-info " runat="server" OnClick="ListImageButton_Click"><i class="fa fa-plus" aria-hidden="true"></i> New Entry </asp:LinkButton>
                                            ...
                                            <div class="table-responsive" id="MainGradeDiv">
                                                ...
                                                <asp:GridView ID="invoiceGridView" runat="server" OnPreRender="gv_DocumentUpload_PreRender" AutoGenerateColumns="False" class="table table-striped table-bordered table-hover"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="AccountNameActual" HeaderText="Account Name" />
                                                        <asp:BoundField DataField="AccountName" HeaderText="Account No" />
                                                        ...
                                                        <asp:BoundField DataField="IsImage" HeaderText="Is Image Added" />
                                    ...
                                    <asp:BoundField DataField="ReferenceDate" HeaderText="Reference Date" />--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:ImageButton ID="ImageButton1" runat="server" ToolTip=""
                                                                    CommandArgument="<%# Container.DataItemIndex %>" CommandName="UpdateData"
    ...
    <div runat="server" visible="false">
        <table width="100%" class="TableWorkArea">
            <tr>
                <td colspan="6" class="TableHeading">Deposit List
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="13%" class="TDLeft" style="text-align: right; padding-right: 10px;">Sales Center:<span class="star-mark"> * </span>
                </td>
                <td width="20%" class="TDRight">
                ...
                <td width="13%" class="TDLeft" style="text-align: right; padding-right: 10px;">Deposit from date: <span class="star-mark">* </span>
                </td>
                <td width="20%" class="TDRight">
                ...
                <td width="13%" class="TDLeft" style="text-align: right; padding-right: 10px;">Deposit to date: <span class="star-mark">* </span>
                </td>
                <td width="20%" class="TDRight">
