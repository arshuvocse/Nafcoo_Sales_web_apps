<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ProformaReport - Copy.aspx.cs" Inherits="SInventory_UI_ProformaReport" %>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                ...
                                                <%--<asp:BoundField DataField="DeliveryQuantity" HeaderText="DeliveryQty" />
                                                <asp:BoundField DataField="DeliveryTotalPrice" HeaderText="Delivery Total Tp" />
                                                <asp:BoundField DataField="DeliveryTotalPriceVatAmount" HeaderText="Delivery Total Vat" />
                                                <asp:BoundField DataField="DeliveryDiscountAmount" HeaderText="Delivery Discount Amount" />
                                                <asp:BoundField DataField="DeliveryNetAmount" HeaderText="Delivery Net Amount" />
                                                <asp:BoundField DataField="ReturnQty" HeaderText="Return Qty" />
                                                <asp:BoundField DataField="ReturnAmount" HeaderText="Return Amount" />--%>
                                                <%--<asp:BoundField DataField="PayAmount" HeaderText="Payment Amount" />--%>
