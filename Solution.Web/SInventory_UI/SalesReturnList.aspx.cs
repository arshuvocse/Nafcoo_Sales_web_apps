...
public partial class SInventory_UI_SalesReturnList : System.Web.UI.Page
{
    ...
    {
        DataTable dtdata = aReturnInvoiceBll.LoadSalesReuturnInvoice(fromDateTextBox.Text, toDateTextBox.Text,salesCenterDropDownList.SelectedValue);
