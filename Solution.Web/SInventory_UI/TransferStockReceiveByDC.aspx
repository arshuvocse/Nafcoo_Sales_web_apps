<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TransferStockReceiveByDC.aspx.cs" Inherits="SInventory_UI_TransferStockReceiveByDC" %>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive" id="MainGradeDiv">
                                                <asp:GridView ID="stockInTraGridView" runat="server"
                                                    AutoGenerateColumns="False" DataKeyNames="ChalanId" CssClass="table table-bordered  text-center thead-dark" OnPreRender="gv_DocumentUpload_PreRender">
                                                    <Columns>
                                                        ...
                                                        <asp:HyperLinkField HeaderText="Receive Product" DataNavigateUrlFields="ChalanId"
                                                            DataNavigateUrlFormatString="TransferReceiveProductByChalanByDC.aspx?ChalanId={0}"
        ...
        <ContentTemplate>
            <div>
                <table width="100%" class="TableWorkArea">
                    <tr>
                        <td colspan="6" class="TableHeading">Stock Received By DC
                        </td>
                        <tr>
                            <td class="TDLeft" width="13%">DC Name :</td>
