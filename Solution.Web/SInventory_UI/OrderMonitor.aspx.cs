...
public partial class SInventory_UI_OrderMonitor : System.Web.UI.Page
{
    ...
    //    {
    //        parameter = parameter + "CustomerCode = '" + custcodenameTextBox.Text.Trim() + "' AN2D ";
    //    }
    ...
    private void LoadInfo()
    {
        try
        {
                ...
                && salesCenterDropDownList.SelectedValue == "" && territoryDropDownList.SelectedValue == "")
            {
                ...
                aDataTable = aSummaryBll.OrderMonitoring_Bizmo(Convert.ToDateTime(fromDateTextBox.Text.Trim()), Convert.ToDateTime(toDateTextBox.Text.Trim()));
                if (aDataTable.Rows.Count > 0)
                {
                    ...
                    decimal total2 = aDataTable.AsEnumerable().Sum(row => row.Field<int?>("Ordertotal") == null ? 0 : row.Field<int>("Ordertotal"));
                    loadGridView.FooterRow.Cells[1].Text = (total2).ToString("#,##0");


                    decimal total3 = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("VALUE") == null ? 0 : row.Field<decimal>("VALUE"));
                    loadGridView.FooterRow.Cells[2].Text = (total3).ToString("");


                    decimal total4 = aDataTable.AsEnumerable().Sum(row => row.Field<int?>("TotalInvoice") == null ? 0 : row.Field<int>("TotalInvoice"));
                    loadGridView.FooterRow.Cells[3].Text = (total4).ToString("#,##0");


                    decimal total5 = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("InvoiceValue") == null ? 0 : row.Field<decimal>("InvoiceValue"));
                    loadGridView.FooterRow.Cells[4].Text = (total5).ToString("#,##0");


                    decimal total6 = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("Rejectvalue") == null ? 0 : row.Field<decimal>("Rejectvalue"));
                    loadGridView.FooterRow.Cells[5].Text = (total6).ToString("#,##0");

                    decimal total7 = aDataTable.AsEnumerable().Sum(row => row.Field<int?>("deleteorder") == null ? 0 : row.Field<int>("deleteorder"));
                    loadGridView.FooterRow.Cells[6].Text = (total7).ToString("#,##0");

                    decimal total8 = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("deletevalue") == null ? 0 : row.Field<decimal>("deletevalue"));
                    loadGridView.FooterRow.Cells[7].Text = (total8).ToString("#,##0");

                    decimal total9 = aDataTable.AsEnumerable().Sum(row => row.Field<int?>("PendinOrder") == null ? 0 : row.Field<int>("PendinOrder"));
                    loadGridView.FooterRow.Cells[8].Text = (total9).ToString("#,##0");

                    decimal total10 = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("PendinOrderValue") == null ? 0 : row.Field<decimal>("PendinOrderValue"));
                    loadGridView.FooterRow.Cells[9].Text = (total10).ToString("#,##0");
             ...
             && salesCenterDropDownList.SelectedValue != "" && territoryDropDownList.SelectedValue != "")
            {
                ...
                //    Convert.ToString(zoneDropDownList.SelectedValue), salesCenterDropDownList.SelectedValue, territoryDropDownList.SelectedValue);
                if (aDataTable.Rows.Count > 0)
                {
                    loadGridView.DataSource = aDataTable;
                    loadGridView.DataBind();
