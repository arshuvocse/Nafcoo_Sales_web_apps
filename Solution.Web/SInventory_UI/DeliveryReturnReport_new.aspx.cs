...
public partial class SInventory_UI_DeliveryReturnReport_new : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        comUnitDetailDataTable = _DAL.GetDeliveryReturnReportListDAL(Parm());
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        if (loadGridView.Rows.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Delivery_Return_Report_List_" + DateTime.Now.ToString("dd_MMM_yyyy_hh_mm_tt") + ".csv");
            Response.Charset = "";
