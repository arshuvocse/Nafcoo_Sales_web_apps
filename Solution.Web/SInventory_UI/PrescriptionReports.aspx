<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="PrescriptionReports.aspx.cs" Inherits="SInventory_UI_PrescriptionReports" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Prescription Reports </div>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DoctorCode" HeaderText="Doctor Id" />
                                                <asp:BoundField DataField="DoctorName" HeaderText="Doctor Name" />
                                                <asp:BoundField DataField="rxOtherDoctor" HeaderText="Other Doctor" />
                                                <asp:BoundField DataField="CreateDate" HeaderText="Submission Date" />
                                                <asp:BoundField DataField="PrescriptionDate" HeaderText="Date of Rx" />
                                                ...
                                                <%--<asp:TemplateField HeaderText="Image">
                                                    <ItemTemplate>
                                                        <asp:HyperLink
                                                            ...
                                                            <asp:Image ID="imgShow" runat="server" CssClass="imgCSS" Width="45" Height="45" />
                                                        </asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>
