...
public partial class SInventory_UI_ProformaorInvoiceReturn : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("ProformaorInvoiceReturn.aspx");
    }
    ...
    protected void saveButton_Click(object sender, EventArgs e)
    {
        ...
        {
            aInvoiceReturnBll.DeleteProforma(proformaInvoiceTextBox.Text.Trim());
            Clear();
        ...
        if (proformaInvoiceTextBox.Text != "" && InvoiceCheckBox.Checked)
        {
            ...
            if (Count==0)
            {
             aInvoiceReturnBll.DeleteDeliveyInvoice(proformaInvoiceTextBox.Text.Trim());
             Clear();
             showMessageBox("Delete successfully !!");
            }
            else
    ...
    protected void proformaInvoiceTextBox_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            bool chk= aInvoiceReturnBll.chkProforma(proformaInvoiceTextBox.Text.Trim());
            if (chk)
            {
            }
            else
