<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyUnitEdit.aspx.cs" Inherits="SInventory_UI_SalesCenterEdit" %>
            ...
            <div >
                <table width="100%" class="TableWorkArea">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Depot Code: <span style="color: orangered">*</span></td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Depot Name <span style="color: orangered">*</span></td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Address: <span style="color: orangered">*</span></td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">
                            Phone No: <span style="color: orangered">*</span></td>
                        <td class="TDRight" width="20%">
                    ...
                    <tr>
                        ...
                        <td width="13%" class="TDLeft">
                            Mobile No: <span style="color: orangered">*</span></td>
                        <td width="20%" class="TDRight">
