                                            ...
                                            <div class="col-8">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        ...
                                                        <asp:CheckBox ID="InvoiceCheckBox" runat="server" AutoPostBack="True" CssClass="SelectchkChoice" Text="Delivery" OnCheckedChanged="InvoiceCheckBox_CheckedChanged" />
                                            ...
                                            <div class="col-8">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <asp:LinkButton ID="submitButton" class="btn btn-danger   btn-sm" runat="server" OnClick="saveButton_Click" OnClientClick="return sweetAlertConfirm_Submit(this);">   <i class="fa fa-trash"></i>&nbsp; Delete</asp:LinkButton>
