                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:TextBox ID="truckNoTextBox" runat="server" CssClass="form-control form-control-sm "></asp:TextBox>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <asp:TextBox ID="prodctCodeTextBox" runat="server" CssClass="form-control form-control-sm "></asp:TextBox>
        ...
        <ContentTemplate>
            <div>
                <table width="100%" class="TableWorkArea">
                    <tr>
                        <td colspan="6" class="TableHeading">Stock Transfer DC to DC
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft">&nbsp;</td>
                        <td width="20%" class="TDRight">From</td>
                        <td width="13%" class="TDLeft">&nbsp;</td>
                        <td width="20%" class="TDRight">To</td>
                        <td width="13%" class="TDLeft">&nbsp;</td>
                        <td width="20%" class="TDRight">&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="TDLeft" width="13%"></td>
                        <td class="TDRight" width="20%">Chalan Date</td>
                        <td class="TDLeft" width="13%"></td>
                        <td class="TDRight" width="20%">ChalanNo</td>
                        <td class="TDLeft" width="13%">&nbsp;</td>
                        <td class="TDRight" width="20%"></td>
                    </tr>
                    <tr>
                        <td width="13%" class="TDLeft"></td>
                        <td width="20%" class="TDRight">From Sales Center Code</td>
                        <td width="13%" class="TDLeft"></td>
                        <td width="20%" class="TDRight">To Sales Center Code</td>
                        <td width="13%" class="TDLeft"></td>
                        <td width="20%" class="TDRight"></td>
                    </tr>
                    <tr>
                        <td width="13%" class="TDLeft"></td>
                        <td width="20%" class="TDRight">Name</td>
                        <td width="13%" class="TDLeft"></td>
                        <td width="20%" class="TDRight">Name</td>
                        <td width="13%" class="TDLeft"></td>
                        <td width="20%" class="TDRight"></td>
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">&nbsp;</td>
                        <td class="TDRight" width="20%">Address</td>
                        <td class="TDLeft" width="13%"></td>
                        <td class="TDRight" width="20%">Address</td>
                        <td class="TDLeft" width="13%"></td>
                        <td class="TDRight" width="20%">&nbsp;</td>
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">&nbsp;</td>
                        <td class="TDRight" width="20%">Truck Number</td>
                        <td class="TDLeft" width="13%"></td>
                        <td class="TDRight" width="20%">Driver Name</td>
                        <td class="TDLeft" width="13%"></td>
                        <td class="TDRight" width="20%">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="TDRight" width="20%">
                            <asp:HiddenField ID="fromCunithiddenValue" runat="server" />
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="TDLeft" width="13%">&nbsp;</td>
                        <td class="TDRight" width="20%">Product Code</td>
                        <td class="TDLeft" width="13%"></td>
                        <td class="TDRight" width="20%"></td>
                        <td class="TDLeft" width="13%">&nbsp;</td>
                        <td class="TDRight" width="20%">&nbsp;</td>
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">&nbsp; </td>
                        <td class="TDRight" width="20%" colspan="2">Taka :&nbsp;&nbsp;
                    ...
                    <tr>
                        <td class="TDLeft" width="13%">&nbsp;</td>
                        <td class="TDRight" width="20%">&nbsp;</td>
                        <td class="TDLeft" width="13%">Chalan No</td>
                        <td class="TDRight" width="20%"></td>
