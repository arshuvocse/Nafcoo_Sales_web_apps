<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ProductWiseStockMovement.aspx.cs" Inherits="SInventory_UI_ProductWiseStockMovement" %>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">
                    <i class="bx bx-customize"></i>Stock Report
                </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="form-group row" runat="server">
                                              ...
                                              <div class="form-group row">
                                               ...
                                               <div class="form-group row" >
                                                <label for="mainName" class="col-sm-5 col-form-label">Product:</label>
         ...
         <%--                                       <asp:BoundField DataField="BatchNo" HeaderText="Batch No" />
                                                ...
                                                <asp:BoundField DataField="OpeningStock" HeaderText="Opening Quantity" />
                                                <asp:BoundField DataField="TotalSTOStockReceiveQty" HeaderText="Receive from WH" />
                                                <asp:BoundField DataField="TotalB2BReceiveQty" HeaderText="B2B Receive" />
                                                <asp:BoundField DataField="TotalStockReceiveQty" HeaderText="Total Received Quantity" />
                                                <asp:BoundField DataField="TransferedOutQty" HeaderText="Transfered Out Quantity" />
                                                <asp:BoundField DataField="ReturnToWh" HeaderText="Return to WH" />
                                                <asp:BoundField DataField="SoldQty" HeaderText="Delivered Quantity" />
                                               <asp:BoundField DataField="FocOrSample" HeaderText="Foc Or Sample" />
                                                <asp:BoundField DataField="ClosingStock" HeaderText="Closing Quantity" />
                                                <asp:BoundField DataField="AvilableQty" HeaderText="Available Quantity" />
                                                <asp:BoundField DataField="BookForDelivery" HeaderText="Booked Quantity" />
                                                <asp:BoundField DataField="FrezeStock" HeaderText="QI/Freeze Quantity" />
   <%--                                             <asp:BoundField DataField="Blocked" HeaderText="Blocked Quantity" />
                                                <asp:BoundField DataField="Restricted" HeaderText="Restricted Quantity" />--%>
                                                <asp:BoundField DataField="Transit" HeaderText="In-Transit Quantity" />
                                    ...
                                    <%--            <asp:BoundField DataField="CurrentstockShowing" HeaderText="Currentstock Showing" />
