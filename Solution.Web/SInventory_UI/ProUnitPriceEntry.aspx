                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        <asp:TextBox ID="costPriceTextBox" runat="server" CssClass="form-control form-control-sm mb-3">0</asp:TextBox>
                                            ...
                                            <div runat="server" id="new" visible="False">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-group">
                                                            <asp:TextBox ID="newCostPriceTextBox" runat="server" CssClass="form-control form-control-sm mb-3">0</asp:TextBox>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-group">
                                                            <asp:TextBox ID="newactiveDtTextBox" runat="server" CssClass="form-control form-control-sm mb-3 datepicker"></asp:TextBox>
