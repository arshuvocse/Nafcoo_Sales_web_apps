<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master"
    AutoEventWireup="true" CodeFile="DelivaryInvoiceCreationAuto.aspx.cs" Inherits="SInventory_UI_DelivaryInvoiceCreationAuto" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Delivery Invoice Creation List</div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <asp:LinkButton ID="EmpCetegoryAddImageButton" Visible="false" CssClass="btn btn-sm btn-outline-info " runat="server" OnClick="EmpCetegoryAddImageButton_Click"><i class="fa fa-pencil" aria-hidden="true"></i> Update Old Data </asp:LinkButton>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
                                    ...
                                    <div class="row">
                                        <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                            ...
                                            <asp:GridView ID="orderGridView" runat="server" AutoGenerateColumns="False"
                                                DataKeyNames="ComUnitId,ManufacId,OrderId,InvoiceId,MarketId,CustomerMasterId" ShowFooter="true" CssClass="table table-bordered  text-center thead-dark" OnPreRender="gv_DocumentUpload_PreRender">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status">
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="statusDropDownList" runat="server" CssClass="form-control form-control-sm mySelect2" AutoPostBack="True"   OnTextChanged="statusDropDownList_OnTextChanged">
                                                    ...
                                                    <asp:TemplateField HeaderText="Auto Payment" Visible="False">
                                                        <ItemTemplate>
                                                            <asp:CheckBox runat="server" Checked="true" Enabled="false" ID="autoPayment" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Submit">
                                                        <ItemTemplate>
                                                            ...
                                                            <contenttemplate>
                                                                <asp:LinkButton ID="gotoinvoiceButton" runat="server" CssClass="btn btn-sm btn-info" Text="Submit" OnClick="gotoinvoiceButton_Click"
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <asp:LinkButton OnClick="btnFinalSubmit_Click"  OnClientClick="return confirm('Are you sure you want to Submit? ?');" runat="server" ID="btnFinalSubmit" class="btn btnMyDesignSaveNew   ">
