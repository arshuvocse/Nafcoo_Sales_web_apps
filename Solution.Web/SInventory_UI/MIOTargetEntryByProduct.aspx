<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="MIOTargetEntryByProduct.aspx.cs" Inherits="SInventory_UI_MIOTargetEntryByProduct" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <asp:DropDownList ID="periodDropDownList"  runat="server" CssClass="form-control form-control-sm mySelect2" AutoPostBack="True" OnSelectedIndexChanged="periodDropDownList_OnSelectedIndexChanged">
                                    ...
                                    <br/>
                                     ...
                                     <div id="gridContainer1" style="height: auto; overflow: auto; width: 85%; margin: 0 auto;">
                                <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Target Quantity">
                                            <ItemTemplate>
                                                <asp:TextBox ID="returnQtyTextBox" CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtenderconvRate" runat="server"
