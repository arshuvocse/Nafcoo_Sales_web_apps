                                    ...
                                    <div class="row">
                                        <div class="table-responsive" id="MainGradeDiv">
                                            ...
                                            <asp:GridView ID="stockInTraGridView" runat="server" AutoGenerateColumns="False"
                                                DataKeyNames="ReqId,IssueChalanNo" CssClass="table table-bordered  text-center thead-dark" onrowcommand="loadGridView_RowCommand" OnPreRender="gv_DocumentUpload_PreRender">
                                                <Columns>
