                    ...
                    <div class="col">
                        ...
                        <div class="card border-top border-0 border-4 border-success">
                            <div class="card-body">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <asp:LinkButton runat="server" ID="btnSearch" class="btn btnMyDesignSearch   btn-sm " OnClick="searchButton_Click">  <i class="fa fa-search-plus"></i>&nbsp; View Master </asp:LinkButton>
                                                <asp:LinkButton runat="server" ID="btnSearch2" class="btn btnMyDesignSearch   btn-sm " OnClick="btnSearch2_Click">  <i class="fa fa-search-plus"></i>&nbsp; View Details </asp:LinkButton>
                                ...
                                <div class="row">
                                    <div class="table-responsive" id="MainGradeDiv" style="text-align: center; height: 20%; overflow: scroll; width: auto; overflow-y: scroll; overflow-x: scroll;">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered  text-center thead-dark" OnPreRender="gv_DocumentUpload_PreRender"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Report">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnReport" runat="server" class="btn-primary  btn-sm mb-1 mb-md-0"
                                                            OnClick="btnReport_OnClick">   <i class="fa fa-print"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
        ...
        <ContentTemplate>
            <div>
                <table width="100%" class="TableWorkArea">
                    <tr>
                        <td colspan="6" class="TableHeading">B2B Transfer view
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="13%" class="TDLeft">&nbsp; Add New :
                        </td>
                        <td width="20%" class="TDRight">
                    ...
                    <tr>
                        ...
                        <td class="TDLeft" width="13%">To Date
                        </td>
