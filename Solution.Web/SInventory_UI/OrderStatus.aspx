                        ...
                        <div class="col">
                            ...
                            <div class="card border-top border-0 border-4 border-success">
                                <div class="card-body">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <asp:LinkButton ID="submitButton" CssClass="btn btn-sm btn-primary mb-2" runat="server" OnClick="searchButton_OnClick" Style="background-color: #00bcd4; color: #fff;">   <i class="fa fa-search-plus"></i>&nbsp; Search</asp:LinkButton>
                                    ...
                                    <h3 class="blue title-widget" style="color: #2196F3; text-shadow: 0 0 2px black;"> Retuen Information </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5" style="margin-top: 6px;">
                                                    ...
                                                    <asp:Label ID="lblReturnInvoiceNo" runat="server" Text=""></asp:Label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="mainName" class="col-sm-4 col-form-label">Return TP Total:</label>

                                                <div class="col-sm-5" style="margin-top: 6px;">

                                                    <asp:Label ID="lblReturnTpTotal" runat="server" Text=""></asp:Label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="mainName" class="col-sm-4 col-form-label">Return TP Discount:</label>

                                                <div class="col-sm-5" style="margin-top: 6px;">

                                                    <asp:Label ID="lblReturnTpDiscount" runat="server" Text=""></asp:Label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="mainName" class="col-sm-4 col-form-label">Return TP VAT:</label>

                                                <div class="col-sm-5" style="margin-top: 6px;">

                                                    <asp:Label ID="lblReturnTpVat" runat="server" Text=""></asp:Label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="mainName" class="col-sm-4 col-form-label"> Return TP Grand Total:</label>

                                                <div class="col-sm-5" style="margin-top: 6px;">

                                                    <asp:Label ID="lblReturnTpGrandTotal" runat="server" Text=""></asp:Label>
                                    ...
                                    <div class="row">
                                        <div class="table-responsive" id="MainGradeDiv2">
                                            ...
                                            <asp:GridView ID="returnGridView" runat="server" CssClass="table  blueTable" OnPreRender="gv_DocumentUpload_PreRender" AutoGenerateColumns="False">
                                                <Columns>
                                                    <asp:BoundField DataField="ProductCode" HeaderText="Product Code" />
                                                    <asp:BoundField DataField="ProductName" HeaderText="Product Name" />
                                                    <asp:BoundField DataField="BatchNo" HeaderText="Batch No" />
                                                    <asp:BoundField DataField="ReturnTotalPrice" HeaderText="Return Total Price" />
                                                    <asp:BoundField DataField="ReturnTotaleVatAmount" HeaderText="Return Vat Amount" />
                                                    <asp:BoundField DataField="ReturnDiscount" HeaderText="Return Discount Amount" />
                                                    <asp:BoundField DataField="ReturnNetAmount" HeaderText="Net Return Amount" />
                                                </Columns>
                                            </asp:GridView>
