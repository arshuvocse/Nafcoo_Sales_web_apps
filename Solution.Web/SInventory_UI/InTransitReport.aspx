<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="InTransitReport.aspx.cs" Inherits="SInventory_UI_InTransitReport" %>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">
                    <i class="bx bx-customize"></i>Receivable Report
                </div>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px;">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="LabelSL" Text='<%# Container.DataItemIndex + 1 %>' runat="server"></asp:Label>
                                                ...
                                                <asp:BoundField DataField="NetAmount" HeaderText="Net Invoice Amount" />
                                                <asp:BoundField DataField="TotalPriceVatAmount" HeaderText="Vat Amount" />
                                                <asp:BoundField DataField="TradeDiscount" HeaderText="Trade Discount" />
