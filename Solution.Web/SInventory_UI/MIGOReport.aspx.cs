    ...
    protected void viewRptButton_Click(object sender, EventArgs e)
    {
        if (fromDateTextBox.Text!="")
        {
            if (toDateTextBox.Text == "")
            {
                ...
                string url = "../SInventory_RPTVIEW/MIGOReportViewer.aspx?fromDate=" + fromDate + "&toDate=" + toDate + "&rpttype=" + rptTypeDropDownList.SelectedValue + "&custcode=" + custCodeTextBox.Text + "&orderno=" + orderNoTextBox.Text;
