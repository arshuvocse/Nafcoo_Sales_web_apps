<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="DepositSlipReport.aspx.cs" Inherits="SInventory_UI_DepositSlipReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Pharma Sales, Collection & Deposition Statement Report</div>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" OnRowCreated="loadGridView_OnRowCreated"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CashinHand" HeaderText="Cash in Hand" />
                                                <asp:BoundField DataField="MArketOutStanding" HeaderText="Market OutStanding" />
                                                <asp:BoundField DataField="TotalOpeningReceivable" HeaderText="Total Opening Receivable" />



                                                <asp:BoundField DataField="SalesOnTP" HeaderText="Sales On TP" />
                                                <asp:BoundField DataField="TpVat" HeaderText="Vat" />
                                                <asp:BoundField DataField="TotalSales" HeaderText="Total Sales" />




                                                <asp:BoundField DataField="CurrentPeriodSales" HeaderText="Current Period Collection" />
                                                <%--   <asp:BoundField DataField="tblBeforeCurrentPeriodSales" HeaderText=" Before Current Period "  />
                                       <asp:BoundField DataField="TotalCollection" HeaderText=" Total Collection "  />--%>




                                                <asp:BoundField DataField="BankDeposit" HeaderText=" Bank " />
                                                <asp:BoundField DataField="AIT" HeaderText=" AIT " />
                                                <asp:BoundField DataField="totalDeposit" HeaderText="  Total Deposit  " />


                                                <asp:BoundField DataField="ClosingCashinHand" HeaderText="  Cash in Hand  " />
                                                <asp:BoundField DataField="ClosingMarketOutstanding" HeaderText="  Market Outstanding  " />
                                                <asp:BoundField DataField="ClosingTotalReceivable" HeaderText="  Total Receivable    " />
    ...
    <div runat="server" visible="false">
        <table width="100%" class="TableWorkArea">
            <tr>
                <td colspan="6" class="TableHeading">Pharma Sales, Collection & Deposition Statement Report																
                </td>
            </tr>
            <tr>
