<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DeliveryPaymentReport.aspx.cs" Inherits="SInventory_UI_DeliveryPaymentReport" %>
                  ...
                  <asp:TextBox ID="todateTextBox" runat="server"  class="form-control form-control-sm mb-3 datepicker" autocomplete="off" placeholder="Select Invoice To Date"></asp:TextBox>
                     ...
                     <div class="col-3" >
                         <div class="form-group row  pull-right">
                             <span style="text-align:right; color:silver" class="  pull-right">Note: Market structure filtering will be  workable from 1st april's data.</span>
                              </div>
                          <div class="form-group row  pull-right">
