                        ...
                        <div class="col">
                            ...
                            <div class="card border-top border-0 border-4 border-success">
                                ...
                                TargetControlID="referenceDateTextBox" PopupButtonID="referenceDateTextBox">
                                        ...
                                        <br />
                                          <div class="row">
                                <div class="col-md-2"><a href="../ExcelFiles/Warehouse_Stock_In_Format.xls"  class="btn  btn-secondary   btn-sm">Download Excel Format</a></div>
                                <div class="col-md-10">
                                    <div class="form-group row">
                                                    ...
                                                    >
                                                        ...
                                                        <asp:TemplateField HeaderText="Batch">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:AutoCompleteExtender ID="batchTextBox_AutoCompleteExtender" runat="server"
                                                                    DelimiterCharacters="" EnableCaching="true"
                                                                    Enabled="True" MinimumPrefixLength="1" CompletionSetCount="10"
                                                        ...
                                                        <asp:TemplateField HeaderText="Mfg.Date">
                                                            <ItemTemplate>
                                                               ...
                                                               <%-- AutoPostBack="True" OnTextChanged="mfgDateTextBox_OnTextChanged"--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Exp.Date">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="expDateDateTextBox" runat="server" Text='<%# Eval("ExpDate")%>'
                                                                    CssClass="form-control form-control-sm datepicker" ></asp:TextBox> 
                                                                <%--AutoPostBack="True" OnTextChanged="expDateDateTextBox_OnTextChanged"--%>
                                                                <%--<asp:ImageButton runat="server" AlternateText="Click to show calendar" ImageUrl="~/Images/Calendar_scheduleHS.png"
                                                        ...
                                                        <asp:TemplateField HeaderText="Price">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExssstender2" runat="server"
                                                                    Enabled="True" TargetControlID="costPriceTextBox" FilterType="Custom" ValidChars="0123456789.">
                                                                </asp:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Vat">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:FilteredTextBoxExtender ID="FilteredTextBssdaasoxExtender2" runat="server"
                                                                    Enabled="True" TargetControlID="vatTextBox" FilterType="Custom" ValidChars="0123456789.">
                                                                </asp:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
