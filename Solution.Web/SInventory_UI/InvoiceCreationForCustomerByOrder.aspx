                                    ...
                                    <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="mainName" class="col-sm-2 col-form-label">Order Time:</label>

                                                <div class="col-sm-2">
                                                    <asp:TextBox ID="txtOrderTime" runat="server" CssClass="form-control form-control-sm " ReadOnly="True"></asp:TextBox>
                                                </div>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Product Name">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="nameTextBox" runat="server" CssClass="form-control form-control-sm "
                                            ...
                                            <div class="row" runat="server" visible="False">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <asp:LinkButton ID="genordButton" CssClass="btn btn-sm btn-primary mb-2" runat="server" OnClick="genordButton_OnClick" Style="background-color: #00bcd4; color: #fff;"> <i class="fa fa-check-square"></i>&nbsp; Change Invoice </asp:LinkButton>
                                            ...
                                            <div class="row">
                                                <div class="table-responsive" id="MainGradeDiv">
                                                    <asp:GridView ID="gridLineItemGridView" runat="server"
                                                        AutoGenerateColumns="False" CssClass="table  blueTable" OnPreRender="gv_DocumentUpload_PreRender" DataKeyNames="ISGiftProduct,IsCampaignProduct">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL" Visible="False">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="slLabel" runat="server" Text='<%# Eval("SL")%>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Code">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HiddenField ID="orderdetailIdHiddenField" runat="server" Value='<%# Eval("OrderDetailsId")%>' />
                                                                    <asp:HiddenField ID="CampaignTypeHiddenField" runat="server" Value='<%# Eval("CampaignType")%>' />
                                                                    <asp:HiddenField ID="hdfIsCampaignProduct" runat="server" />
                                                                    <asp:HiddenField ID="hdfIsGiftProduct" runat="server" />
                                                            ...
                                                            <asp:TemplateField HeaderText="UP">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="unitPriceTextBox" runat="server" CssClass="form-control form-control-sm "
                                                                        Text='<%# Eval("UnitPrice")%>' ReadOnly="True"></asp:TextBox>
                                                                    <asp:HiddenField ID="hdfOrderQuantity" Value="0" runat="server" />
                                                                    <asp:FilteredTextBoxExtender ID="funitPriceTextBox" runat="server"
                                                                        TargetControlID="unitPriceTextBox"
                                                                        FilterType="Custom, Numbers"
                                                                        ValidChars="." />
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <div class="row" id="lowstockMsg" runat="server" Visible="True">
                                                <div class="col-3"></div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <div class="alert alert-danger text-center" role="alert" style="font-size: 16px !important; color: red !important;">
                                                            Low stock! Proceeding may exclude some products. Review before generating the invoice.
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-3"></div>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <asp:TextBox ID="adjustInvoiceNoTextBox" runat="server" CssClass="form-control form-control-sm"> </asp:TextBox>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <asp:LinkButton ID="submitButton" CssClass="btn btn-sm btn-primary mb-2" runat="server" OnClick="saveButton_Click" Style="background-color: #00bcd4; color: #fff;"
                                                                OnClientClick="return confirm('Are you sure you want to Booking? ?');"> <i class="fa fa-check-square"></i>&nbsp; Invoice Generate</asp:LinkButton>

                                                            <%--OnClientClick="return confirm('Are you sure you want to Booking? ?');">--%>
