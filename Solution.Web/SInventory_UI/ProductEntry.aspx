                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="border border-3 p-4 rounded">
                                                    ...
                                                    <div class="mb-3" runat="server" Visible="False">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="border border-3 p-4 rounded">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="../DoctorModule_UI/GenericGroupView.aspx" title="Go to this Page" target="_blank">Generic Group</a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="loadGenericGroup" OnClick="loadGenericGroup_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="../DoctorModule_UI/TharapeuticGroupView.aspx" title="Go to this Page" target="_blank">Therapeutic Group </a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="loadTherapeutic" OnClick="loadTherapeutic_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>

                                                        </div>

                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label">Product Group </label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="loadp_Group" OnClick="loadp_Group_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>

                                                        </div>

                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="../DoctorModule_UI/ProductLineEntry.aspx" title="Go to this Page" target="_blank">Product Line</a>  </label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="load_ProLine" OnClick="load_ProLine_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>

                                                        </div>
                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="ProCategoryEntry.aspx" title="Go to this Page" target="_blank">Category</a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="catLoad" OnClick="catLoad_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>

                                                        </div>

                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="ManufacturerEntry.aspx" title="Go to this Page" target="_blank">Manufacturer</a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="ManufacturerLoad" OnClick="ManufacturerLoad_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="PackSizeEntry.aspx" title="Go to this Page" target="_blank">Pack Size</a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="packSizeLoad" OnClick="packSizeLoad_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="StockUOMEntry.aspx" title="Go to this Page" target="_blank">UOM</a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="UOMLoad" OnClick="UOMLoad_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="../SInventory_UI/ProTypeEntry.aspx" title="Go to this Page" target="_blank">Product Type</a> </label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="ProtypeLoad" OnClick="ProtypeLoad_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="ProductSQEntry.aspx" title="Go to this Page" target="_blank">Product Brand</a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="productBrandLoad" OnClick="productBrandLoad_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>

                                                        </div>

                                                        <div class="col-12">
                                                            <label for="inputProductType" class="form-label"><a href="../SInventory_UI/ShippingCartonSizeEntry.aspx" title="Go to this Page" target="_blank">Shipping Carton</a></label>
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text text_Link">
                                                                    <asp:LinkButton runat="server" ID="ShippingLoad" OnClick="ShippingLoad_Click"><i class="fa fa-refresh"></i></asp:LinkButton></span>
                                                            </div>
