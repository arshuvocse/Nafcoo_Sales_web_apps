        ...
        if (fromDateTextBox.Text != "" && toDateTextBox.Text != "")
        {
            ...
            try
            {
                ...
                if (aDataTable.Rows.Count > 0)
                {
                    ...
                    decimal total6 = aDataTable.AsEnumerable().Sum(row => row.Field<decimal?>("TotalSales") == null ? 0 : row.Field<decimal>("TotalSales"));
                    ...
                    loadGridView.FooterRow.Cells[12].Text = Math.Round(total13).ToString("#,##0");
                    ...
                    loadGridView.FooterRow.Cells[13].Text = Math.Round(total14).ToString("#,##0");
                    ...
                    loadGridView.FooterRow.Cells[14].Text = Math.Round(total15).ToString("#,##0");
