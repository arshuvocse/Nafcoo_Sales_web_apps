...
public partial class SInventory_UI_ProductWiseStockMovement : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        else
        {
            ...
            comUnitDetailDataTable = aReportDal.LoadStockmovementReport(Convert.ToDateTime(fromDateTextBox.Text), Convert.ToDateTime(todateTextBox.Text), idd, ProCode, BranchName);
