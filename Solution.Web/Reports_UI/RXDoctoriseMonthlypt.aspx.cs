...
public partial class Reports_UI_RXDoctoriseMonthlypt : System.Web.UI.Page
{
        ...
        private void LoadData()
    {
        ...
        if (rbReportTypeName.Items[1].Selected)
        {
            ...
            DataTable aDataTable = _DAL.GetRXDoctorBrandWiseList(mainDate_, ddlmonth.SelectedValue, ddlYear.SelectedValue);
        ...
        if (rbReportTypeName.Items[2].Selected)
        {
          ...
          string  mainDate_ = mainDate.TrimEnd(',');
            DataTable aDataTable = _DAL.GetRXDoctorProductWiseList(mainDate_, ddlmonth.SelectedValue, ddlYear.SelectedValue);
            string html = "<table id='tblTable' style='height:200px;' class='table table-bordered text-center thead-dark table-hover table-striped tableFixHead' >";
            html = html + "<thead> " + "<tr>" ;
            for (int i = 0; i < aDataTable.Columns.Count; i++)
            {
        ...
        if (rbReportTypeName.Items[3].Selected)
        {
            ...
            string mainDate_ = mainDate.TrimEnd(',');
            DataTable aDataTable = _DAL.GetRXUserWiseList(mainDate_, ddlmonth.SelectedValue, ddlYear.SelectedValue);
            string html = "<table id='tblTable' style='height:200px;' class='table table-bordered text-center thead-dark table-hover table-striped tableFixHead' >";
            html = html + " <thead><tr> ";
