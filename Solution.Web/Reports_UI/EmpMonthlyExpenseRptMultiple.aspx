<%@ Page Title=" Employee Monthly Expense List" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="EmpMonthlyExpenseRptMultiple.aspx.cs" Inherits="Reports_UI_EmpMonthlyExpenseRptMultiple" %>
                 ...
                 <div class="col-md-12">
                                   ...
                                   <div class="col-md-2">
                                     ...
                                     <div class="col-md-3">
                                          ...
                                          <asp:LinkButton ID="btnPrint" runat="server" CssClass="btn btn-info " OnClick="btnPrint_OnClick" ><span aria-hidden="true" class="fa fa-print" ></span> &nbsp;Print Report</asp:LinkButton>  
                                         <asp:LinkButton ID="btnExportToExcel" runat="server" CssClass="btn btn-success pull-right" OnClick="btnExportToExcel_Click" ><span aria-hidden="true" class="fa fa-file" ></span> &nbsp;View Report</asp:LinkButton>
                        ...
                        <div style="padding-top:10px;"></div>
                               ...
                               <asp:BoundField DataField="MilageExpense" HeaderText="Mileage Expense" />
                               <asp:BoundField DataField="ExpenseAmount" HeaderText="Expense" />

                               <asp:BoundField DataField="MonthlyAllowance" HeaderText="Allowance Amount" />

                               <asp:BoundField DataField="TotalExp" HeaderText="Total" />
