...
public partial class Reports_UI_DWSPMonthlyRpt : System.Web.UI.Page
{
        ...
        private void LoadData()
    {
        ...
        if (RoleTypeName == "DZSM")
        {
            ...
            aDataTable = _DAL.GetDWSPMonthlyList_Mew(Convert.ToInt32(ddlmonth.SelectedValue), ddlmonth.SelectedItem.Text, ddlYear.SelectedValue, ddlApprovalStatus.SelectedValue, F_ZoneSelect.SelectedValue);
            }
            else
            {
