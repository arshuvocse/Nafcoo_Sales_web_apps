...
public partial class Reports_UI_EmpMonthlyExpenseRptMultiple : System.Web.UI.Page
{
    ...
    {
        DataTable aDataTable = _EmployeeInformationDaL.GetEmployeeInformationListForReport(param());
    ...
    private string param()
    {
        ...
        if (ddlEmployeeStatus.SelectedValue != "0")
        {
            ...
            param = param + "   and PM.EmpInfoId in (select EmpInfoId from tbluser where UserStatus='" + ddlEmployeeStatus.SelectedValue + "')";
