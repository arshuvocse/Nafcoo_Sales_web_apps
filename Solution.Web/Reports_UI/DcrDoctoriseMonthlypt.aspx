<%@ Page Title="Doctor Call Plan Report" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DcrDoctoriseMonthlypt.aspx.cs" Inherits="Reports_UI_DcrDoctoriseMonthlypt" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Doctor Call Plan Report</div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8" runat="server" visible="false">
                                                    ...
                                                    <asp:RadioButtonList runat="server" ID="rbType" CssClass="radioChoice" AutoPostBack="True" OnSelectedIndexChanged="rbType_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                                        <asp:ListItem Selected="True" Value="0">DCR</asp:ListItem>
                                                    ...
                                                    <asp:RadioButtonList runat="server" ID="rbReportTypeName" CssClass="radioChoice2" AutoPostBack="True" OnSelectedIndexChanged="rbReportTypeName_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatColumns="1" RepeatLayout="Flow">
                                                        ...
                                                        <asp:ListItem Value="3">Product Wise</asp:ListItem>
                                                           ...
                                                           <%-- <asp:ListItem Value="5">Doctor Coverage Report</asp:ListItem>--%>
                                                    </asp:RadioButtonList>
                                                     </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 ">
                                            <asp:LinkButton ID="btnExportToExcel" Visible="false" runat="server" CssClass="btn btn-success pull-right" OnClick="btnExportToExcel_Click"><span aria-hidden="true" class="fa fa-file-excel-o" ></span> &nbsp;Export To Excel</asp:LinkButton>
                                    ...
                                    <div class="table-responsive" id="export" style="height:600px">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="GroupName" HeaderText="National" />

                                                <asp:BoundField DataField="GroupCode" HeaderText="National Code" />
                              ...
                              <script type="text/javascript">
                                  ...
                                  function exporttocsv() {
                                      ...
                                      //}
                                      $("#export").tableToCSV({
                                          filename: txt +' Doctor Call Plan Report'
                                      });
                                  }
                              </script>
                                        ...
                                        <script>
                                            function exportToExcel() {
                                                ...
                                                var a = $("<a />", {
                                                    href: url,
                                                    download: "Doctor_Call_Plan_Report.xls"
