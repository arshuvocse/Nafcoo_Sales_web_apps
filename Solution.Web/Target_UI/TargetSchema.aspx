<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TargetSchema.aspx.cs" Inherits="Target_UI_TargetSchema" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Target Schema </div>
                        ...
                        <div class="card-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:HiddenField runat="server" ID="id_masterID" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div class="form-group row">
                                                <label for="txtNID" class="col-sm-3 col-form-label">Schema Name:</label>

                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm  clsDecimal" runat="server" placeholder="Schema Name" ID="tbxSchemaName" ></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div class="form-group row">
                                                <label for="txtNID" class="col-sm-3 col-form-label">Schema Amount:</label>

                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        <asp:TextBox class="form-control form-control-sm  clsDecimal" runat="server" placeholder="Amount" ID="tbxSchemaAmount" ></asp:TextBox>
                                                    <span class="input-group-text text-c-red">*</span>
                                                    </div>
                                                ...
                                                <asp:GridView ID="gv_ProductList" runat="server" AutoGenerateColumns="False"  DataKeyNames="ProductCode"
                                                    ...
                                                    <Columns>
                                                       ...
                                                       <asp:TemplateField HeaderText="Percent">
                                                            <ItemTemplate>
                                                                <div class="input-group">
                                                                    <asp:TextBox class="form-control form-control-sm  clsDecimal" runat="server" placeholder="Amount" ID="tbxSchemaPercentage" ></asp:TextBox>
                                                                <span class="input-group-text text-c-red">*</span>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
