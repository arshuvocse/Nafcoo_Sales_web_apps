<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master"
    AutoEventWireup="true" CodeFile="TargetDeclarationExcelUpload.aspx.cs" Inherits="Target_UI_TargetDeclarationExcelUpload" %>
  ...
  <%--    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>   Target Declaration Data Upload </div>
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                                           ...
                                           <a href="TargetDeclarationView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-2"><a href="../Approval_UI/TargetDeclarationExcel_Formate3.xls" class="btn  btn-secondary   btn-sm">Download Excel Format</a>  </div>
                                    <div class="col-md-10">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Territory Code">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="hfTerritoryId" runat="server"></asp:HiddenField>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="Month" HeaderText="Month"/>
                                                <asp:BoundField DataField="Year" HeaderText="Year"/>

                                                <asp:TemplateField HeaderText="Schema Code">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSchemaCode" runat="server" Text='<%# Bind("SchemaCode") %>'></asp:Label>
                                                        <asp:HiddenField ID="hfSchemaId" runat="server"></asp:HiddenField>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
