<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TargetDeclarationView.aspx.cs" Inherits="Target_UI_TargetDeclarationView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Target Declaration View </div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            OnPageIndexChanging="loadGridView_PageIndexChanging" onrowcommand="loadGridView_RowCommand" DataKeyNames="TargetDeclarationId">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SL#">
                                                    <ItemTemplate>
                                                        <%#Container.DataItemIndex+1 %>
                                                        <asp:HiddenField runat="server" ID="hfTargetSchemaDetailId" Value='<%#Eval("TargetDeclarationId")%>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="SchemaCode" HeaderText="Schema Name" />
                                                <asp:BoundField DataField="SchemaName" HeaderText="Schema Code" />
                                                <asp:BoundField DataField="MonthName" HeaderText="Month" />
                                                <asp:BoundField DataField="Year" HeaderText="Year" />
                                                <asp:BoundField DataField="UserName" HeaderText="Entry By" />
