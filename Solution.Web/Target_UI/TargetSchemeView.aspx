<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="TargetSchemeView.aspx.cs" Inherits="Target_UI_TargetSchemeView" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Target Schema View </div>
                                ...
                                <ContentTemplate>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList 
                                                        ...
                                                        OnSelectedIndexChanged="schemaDropdown_IndexChange">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: 600px">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            OnPageIndexChanging="loadGridView_PageIndexChanging" onrowcommand="loadGridView_RowCommand" DataKeyNames="SchemaMasterId">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SL#">
                                                    <ItemTemplate>
                                                        <%#Container.DataItemIndex+1 %>
                                                        <asp:HiddenField runat="server" ID="hfTargetSchemaDetailId" Value='<%#Eval("SchemaDetailId")%>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="SchemaAmount" HeaderText="Schema Amount" />
