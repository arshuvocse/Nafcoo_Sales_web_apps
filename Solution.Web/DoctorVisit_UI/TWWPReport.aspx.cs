...
public partial class DoctorVisit_UI_NewDCRReport : System.Web.UI.Page
{
    ...
    {
        DataTable aDataTable = _DoctorVisit_DAL.GetTwwpReport(param());
    ...
    private string param()
    {
        ...
        {
            param = param + " AND CONVERT(date,TD.EntryDate)  BETWEEN '" + FromDate.Text + "' AND '" + ToDate.Text + "' ";
        }
        if (FromDate.Text != "" && ToDate.Text == "")
        {
            param = param + " AND CONVERT(date,TD.EntryDate)  BETWEEN '" + FromDate.Text + "' AND '" + DateTime.Now.ToString("dd-MMM-yyyy") + "' ";
        }
        ...
        if (UserRoleSelect.SelectedValue != "")
        {
            ...
            param = param + " AND EGI.EmpInfoId ='" + UserRoleSelect.SelectedValue + "'";
        ...
        if (EmployeeIdSelect.SelectedValue != "")
        {
            ...
            param = param + " AND USR.UserRoleID ='" + EmployeeIdSelect.SelectedValue + "'";
