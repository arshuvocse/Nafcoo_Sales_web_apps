<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="WorkScheduleReport.aspx.cs" Inherits="DoctorVisit_UI_NewDCRReport" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Work Schedule Report </div>
                        ...
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <h4><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp; Work Schedule List </h4>
                                        </div>
                                        <div class="col-5">
                                        </div>
                                        <div class="col-3">
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="min-height: 400px">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="TerritoryName" HeaderText="Sub Territory" />
                                                ...
                                                <asp:BoundField DataField="DCPDate" HeaderText="Date" />
