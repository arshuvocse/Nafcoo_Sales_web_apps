<%@ Page Title="Group List" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="GroupSetupView.aspx.cs" Inherits="DoctorModule_UI_GroupSetupView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>  Group List</div>
                
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="../DoctorModule_UI/GroupSetupEntry.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
    ...
    <script type="text/javascript">
        ...
        function GetDegree() {
            var urlpath = 'GroupSetupView.aspx/GetGroupSetupList';
            $.ajax({
                url: urlpath,
                dataType: 'json',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        row += "<tr>";
                        row += "<td>" + (i + 1) + "</td>";
                        row += "<td>" + un(result[i].GroupCode)+ "</td>";
                        ...
                        row += "<td><button class='btn-outline-warning    btn-xs mb-1 mb-md-0 '  type='button'  onclick='editClick(" + result[i].GroupId + ")'   ><i class='bx bxs-edit' aria-hidden='true'></i></button>  </td>";
