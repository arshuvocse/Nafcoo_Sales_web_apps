<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="InvoiceType.aspx.cs" Inherits="DoctorModule_UI_InvoiceType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    .form-check {
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Invoice Type Entry </div>

                <div class="ms-auto">
                    <div class="btn-group">

                        <a href="../DoctorModule_UI/InvoiceTypeView.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp;Back to List</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="form-group row">
                                    <label for="mainName" class="col-sm-3 col-form-label">Invoice Type name:  </label>
    ...
    function FinalSave() {
        ...
        var jsonData = {};
        jsonData["InvoiceTypeId"] = $('#ContentPlaceHolder1_masterId').val();
        jsonData["TypeName"] = $.trim($('#mainName').val());
        jsonData["IsActive"] = $('#customSwitch1').is(':checked');
        jsonData["Activedate"] = $('#acDate').val();
    
        $.ajax({

            url: "InvoiceType.aspx/Save_InvoiceType",
            ...
            async: true,   
                ...
                success: function (result) {
                    ...
                    if (result.d.isSuccess == true) {
                        ...
                        successalert('Operation successful!', 'Success', 'InvoiceTypeView.aspx');
    ...
    function GetDocDesignation(id) {
            ...
            $.ajax({
                url: 'InvoiceType.aspx/GetInvoiceTypeEditData',
                type: 'post',
                contentType: 'application/json;charset=utf-8',
                dataType: 'json',
                data: "{id : '" + id + "'}",
