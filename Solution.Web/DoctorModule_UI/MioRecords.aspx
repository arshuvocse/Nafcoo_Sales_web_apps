    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> ABM List</div>
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (result[i].IsActive) {
                            ...
                            row += "<td><button class='btn-outline-warning    btn-xs mb-1 mb-md-0 ' disabled title='Cannot be edited' type='button'  onclick='editClick(" + result[i].MIOId + ")'   ><i class='bx bxs-edit' aria-hidden='true'></i></button>  </td>";
                        }
