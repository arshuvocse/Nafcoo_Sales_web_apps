...
public partial class DoctorModule_UI_UserRecords : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        DataTable dt = _setupDAL.Get_UserListInfo(Parm());
    ...
    private string Parm()
    {
        ...
        {
            param = param + " AND UR.UserRoleID='" + ddlUserRole.SelectedValue + "' ";
        }

        if (ddlActiveStatus.SelectedValue != "")
        {
            param = param + " AND UR.UserStatus='" + ddlActiveStatus.SelectedValue + "' ";
        }
        return param;
    }
