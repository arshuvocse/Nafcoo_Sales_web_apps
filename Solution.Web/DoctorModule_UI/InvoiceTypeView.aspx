<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="InvoiceTypeView.aspx.cs" Inherits="DoctorModule_UI_InvoiceTypeView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Invoice Type list </div>
                
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="../DoctorModule_UI/InvoiceType.aspx"  class="btn btn-sm btn-outline-info " ><i class="fa fa-plus" aria-hidden="true"></i> New Entry</a>
    ...
    <script type="text/javascript">
        ...
        function locationChange() {
            window.location.href = '../DoctorModule_UI/InvoiceType.aspx';
        }
        
        function GetDoctorDesignation() {
            $.ajax({
                url: 'InvoiceTypeView.aspx/Get_InvoiceType',
                type: 'post',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {            
                        ...
                        row += "<td><button class='btn-outline-warning btn-xs mb-1 mb-md-0' onclick='editClick(" + result[i].InvoiceTypeId + ")'><i class='bx bxs-edit' aria-hidden='true'></i></button> </td>";
        ...
        function editClick(id) {
            window.location.href = '../DoctorModule_UI/InvoiceType.aspx?id=' + id;
        }
        ...
        function Final_DeleteClick(id) {
            var Id = id;
            $.ajax({   
                url: 'InvoiceTypeView.aspx/Delete_InvoiceType',
                type: 'post',
                contentType: 'application/json;charset=utf-8',
                dataType: 'json',
                data: "{Id : '" + Id + "'}",
