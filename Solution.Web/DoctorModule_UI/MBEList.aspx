<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="MBEList.aspx.cs" Inherits="DoctorModule_UI_MBEList" %>
...
<div class="container-fluid" style="width: 100% !important;">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> MBE List</div>

                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="../DoctorModule_UI/MBESetup.aspx" class="btn btn-sm btn-outline-info "><i class="fa fa-plus" aria-hidden="true"></i>New Entry</a>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
    ...
    <script>
        ...
        function LoadRSMInfo() {
            var urlpath = 'FieldForce.aspx/GetMBEList';
            $.ajax({
                url: urlpath,
                dataType: 'json',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        row += "<td>" + un(result[i].ActiveStatus) + "</td>";
                        if (result[i].IsActive) {
                            row += "<td><button class='btn-outline-warning    btn-xs mb-1 mb-md-0 '  type='button'  onclick='editClick(" + result[i].MBEInfoId + ")'   ><i class='bx bxs-edit' aria-hidden='true'></i></button>  </td>";
                        }
                        else {
                            row += "<td><button class='btn-outline-warning    btn-xs mb-1 mb-md-0 ' disabled title='Cannot be edited' type='button'  onclick='editClick(" + result[i].MBEInfoId + ")'   ><i class='bx bxs-edit' aria-hidden='true'></i></button>  </td>";
                        }                   
                        row += "</tr>";
                    }
        ...
        function editClick(id) {
            location.href = 'MBESetup.aspx?id=' + id + '';
        }
