...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <div class="form-group row">
                                                <label for="mainName" class="col-sm-4 col-form-label">Sales Line: </label>

                                                <div class="col-sm-8">
                                                    <asp:DropDownList ID="ddlSalesLine" runat="server" CssClass="form-select form-select-sm mySelect2"></asp:DropDownList>
                                                </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="form-group row" runat="server">
                                                ...
                                                <div class="col-sm-8">
                                                    <asp:DropDownList ID="EmployeeIdSelect" runat="server" CssClass="form-select form-select-sm mySelect2"></asp:DropDownList>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="form-group row" runat="server">
                                                <label for="mainName" class="col-sm-4 col-form-label"> User Role: </label>
                                    ...
                                    <div class="row" runat="server" visible="False">
                                        ...
                                        <div class="col-5" runat="server" visible="false">
                                            <div class="form-group row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <%--<asp:Label Text="Show" runat="server" /> visi <asp:DropDownList ID="ddlPageSize" runat="server" CssClass="form-control form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="PageSize_Changed">
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv">
                                        ...
                                        <asp:GridView ID="loadGridView" runat="server" AutoGenerateColumns="False"
                                            OnRowCommand="loadGridView_RowCommand" CssClass="table table-striped table-bordered" OnPreRender="gv_DocumentUpload_PreRender" AllowPaging="True" PageSize="50" PageIndex="0" OnPageIndexChanging="loadGridView_PageIndexChanging">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="SalesLine" HeaderText="Sales Line" />
                                                <asp:BoundField DataField="RegionName_Att" HeaderText="Cluster" />
                                                <asp:BoundField DataField="AreaName_Att" HeaderText="Region" />
                                                <asp:BoundField DataField="TerritoryName_Att" HeaderText="Area" />
                                                <asp:BoundField DataField="SubTerritoryName_Att" HeaderText="Territory" />
                                                ...
                                                <asp:BoundField DataField="MI_TourType" HeaderText="IN Tour Type" />
                                                ...
                                                <asp:BoundField DataField="PInLoc" HeaderText="IN GEO Location" />

                                                <asp:BoundField DataField="MI_WorkPlace" HeaderText="IN WorkPlace" />
                                                <asp:BoundField DataField="InAddress" HeaderText="IN Address" />
                                                ...
                                                <asp:BoundField DataField="POutLoc" HeaderText="OUT GEO Location" />
                                                <asp:BoundField DataField="MO_WorkPlace" HeaderText="OUT WorkPlace" />
                                                <asp:BoundField DataField="OutAddress" HeaderText="OUT Address" />
                                        ...
                                        <div style="display: none">
                                            <asp:GridView ID="GridView1" PageSize="50"  runat="server" AutoGenerateColumns="False"
                                                OnRowCommand="loadGridView_RowCommand" CssClass="table table-striped table-bordered"
                                                OnPreRender="gv_DocumentUpload_PreRender" AllowPaging="True" PageIndex="0" OnPageIndexChanging="loadGridView_PageIndexChanging">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="PunchInTime" HeaderText="IN Time" />
                                                    <asp:BoundField DataField="PInLoc" HeaderText="IN Geo Location" />
                                                    ...
                                                    <asp:BoundField DataField="PunchOutTime" HeaderText="OUT  Time" />
                                                    <asp:BoundField DataField="POutLoc" HeaderText="OUT Geo Location" />
    ...
    <%--
                                     ...
                                     <asp:BoundField DataField="EI_TourType" HeaderText="IN Tour Type" />
                                 
                                     <asp:TemplateField HeaderText="IN Time">
                                        <ItemTemplate>
                                             <asp:Label ID="lbl_GroupName" runat="server" Text='<%#Eval("E_PunchInTime") %>'></asp:Label>
                                            <a  data-toggle='tooltip' title='Show in map'    target='_blank' style='font-size:20px;display:<%# Eval("E_IN_AttStatus") %>' href='http://maps.google.com/?q="<%# Eval("E_PInLoc") %>"'  class='bx bx-location-plus'></a>
                                            </ItemTemplate>
                                         </asp:TemplateField>
                                 
                                    <asp:BoundField DataField="EI_WorkPlace" HeaderText="IN WorkPlace" />
                                        <asp:BoundField DataField="EIN_AttAddress"  HeaderText="IN Address"  />
                                    

                                       <asp:BoundField DataField="EO_TourType" HeaderText="OUT Tour Type" />
                                     <asp:TemplateField HeaderText="OUT Time">
                                        <ItemTemplate>
                                             <asp:Label ID="lbl_GjjsasrosadupName" runat="server" Text='<%#Eval("E_PunchInTime_2") %>'></asp:Label>
                                            <a  data-toggle='tooltip' title='Show in map'    target='_blank' style='font-size:20px;display:<%# Eval("E_OUT_AttStatus") %>' href='http://maps.google.com/?q="<%# Eval("E_PInLoc_2") %>"'  class='bx bx-location-plus'></a>
                                            </ItemTemplate>
                                         </asp:TemplateField>

                                   <asp:BoundField DataField="EO_WorkPlace" HeaderText="OUT WorkPlace" />
                                    <asp:BoundField DataField="EO_AttAddress"   HeaderText="OUT Address"   />
