<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="NSMRecords.aspx.cs" Inherits="DoctorModule_UI_NSMRecords" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="../DoctorModule_UI/NSMSetup.aspx" class="btn btn-sm btn-outline-info "><i class="fa fa-plus" aria-hidden="true"></i>New Entry</a>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
    ...
    <script>
        ...
        function LoadNSMInfo() {
            ...
            var urlpath = 'FieldForce.aspx/GetNSMList';
            $.ajax({
                url: urlpath,
                dataType: 'json',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (result[i].IsActive) {
                            row += "<td><button class='btn-outline-warning    btn-xs mb-1 mb-md-0 '  type='button'  onclick='editClick(" + result[i].NSMId + ")'   ><i class='bx bxs-edit' aria-hidden='true'></i></button>  </td>";
                        }
                        else {
                            row += "<td><button class='btn-outline-warning    btn-xs mb-1 mb-md-0 ' disabled title='Cannot be edited' type='button'  onclick='editClick(" + result[i].NSMId + ")'   ><i class='bx bxs-edit' aria-hidden='true'></i></button>  </td>";
                        }
                     //   else {
        ...
        function editClick(id) {
            ...
            location.href = '../DoctorModule_UI/NSMSetup.aspx?id=' + id + '';
        }
