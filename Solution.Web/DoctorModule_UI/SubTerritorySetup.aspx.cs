...
public partial class DoctorModule_UI_SubTerritorySetup : System.Web.UI.Page
{
    ...
    private void GetOneRecord(string Id)
    {
        try
        {
            using (DataTable dt = _setupDAL.GetEditData_SubTerritoryOne(Convert.ToInt32(Id)))
            {
                ...
                txtTerritoryCode.Text = dt.Rows[0]["SubTerritoryCode"].ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validation())
        {
            ...
            aMaster.SubTerritoryCode = string.IsNullOrEmpty(txtTerritoryCode.Text) ? null : txtTerritoryCode.Text;
    ...
    public bool Validation()
    {
        ...
        txtTerritoryCode.CssClass = "form-control form-control-sm";
        ...
        {
            txtTerritoryCode.ToolTip = "please fill out this field";
            txtTerritoryCode.CssClass = "form-control form-control-sm is-invalid";
