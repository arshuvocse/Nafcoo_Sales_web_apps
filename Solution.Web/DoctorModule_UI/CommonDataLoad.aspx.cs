...
public partial class DoctorModule_UI_CommonDataLoad : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string GetSubTerritory_ByAreaId_Active(int id)
    {
    ...
    [WebMethod]
    public static string GetNSMEmployee_All(int id)
    {
        DataTable dt = _dataLoad.GetNSMEmployee_All(id);
        string JSONresult;
        JSONresult = JsonConvert.SerializeObject(dt);
        return JSONresult;
    }
    ...
    [WebMethod]
    public static string GetDZSMEmployee_All(int id)
    {
        DataTable dt = _dataLoad.GetDZSMEmployee_All(id);
        string JSONresult;
        JSONresult = JsonConvert.SerializeObject(dt);
        return JSONresult;
    }
    ...
    [WebMethod]
    public static string GetAMEmployee_All(int id)
    {
        DataTable dt = _dataLoad.GetAMEmployee_All(id);
        string JSONresult;
        JSONresult = JsonConvert.SerializeObject(dt);
        return JSONresult;
    }
    ...
    [WebMethod]
    public static string GetMIOEmployee_All(int id)
    {
        DataTable dt = _dataLoad.GetMIOEmployee_All(id);
        string JSONresult;
        JSONresult = JsonConvert.SerializeObject(dt);
        return JSONresult;
    }
    ...
    [WebMethod] public static string GetExpenseField_ByExpenseType(int id)
    {
    ...
    [WebMethod]
    public static string GetCustomerType_All()
    {
        DataTable dt = _dataLoad.GetCustomerType_All();
        string JSONresult;
        JSONresult = JsonConvert.SerializeObject(dt);
        return JSONresult;
    }
    ...
    [WebMethod]
    public static string GetThanaInfo_All()
    {
        DataTable dt = _dataLoad.GetThanaInfo_All();
        string JSONresult;
        JSONresult = JsonConvert.SerializeObject(dt);
        return JSONresult;
    }
    ...
    [WebMethod]
    public static string GetMarket_ByTerritoryId_All(int id)
    {
        DataTable dt = _dataLoad.GetMarket_ByTerritoryId_All(id);
        string JSONresult;
        JSONresult = JsonConvert.SerializeObject(dt);
        return JSONresult;
    }
