<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="ExpenseType.aspx.cs" Inherits="DoctorModule_UI_ExpenseType" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i>Expense Type Information</div>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_IsRequied" runat="server" Text='<%#Eval("IsRequied") %>'></asp:Label>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Remove">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="deleteImageButton" runat="server" OnClick="deleteImageButton_Click"  OnClientClick="return sweetAlertConfirm_Delete(this);"   CssClass="btn-danger  btn-sm mb-1 mb-md-0"
