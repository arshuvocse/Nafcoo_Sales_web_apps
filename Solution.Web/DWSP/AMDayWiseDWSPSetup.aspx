<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AMDayWiseDWSPSetup.aspx.cs" Inherits="DWSP_AMDayWiseDWSPSetup" %>
                              ...
                              <%--                  <span id="v-groupname" class="invalid-tooltip fade hide" data-delay="2000">
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group">
                                               <asp:DropDownList  runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTerritory_SelectedIndexChanged" id="ddlTerritory"  CssClass="form-select form-select-sm mb-3 mySelect2"></asp:DropDownList>
                                ...
                                <div style="padding-top:10px;"></div>
                                     	<div class="card">
											<div class="card-body">
												...
												<p style="font-size:18px;">Total General Amount: <asp:Label  CssClass="HeaderCls" ID="lblGeneral" Text="0" runat="server"></asp:Label> <span class="vl"></span> Total FCB Amount: <asp:Label  CssClass="HeaderCls" ID="lblFCBAmount" Text="0" runat="server"></asp:Label>   <span class="vl"></span>  Total Campaign Amount: <asp:Label  CssClass="HeaderCls" ID="lblCampaign" Text="0" runat="server"></asp:Label> <span class="vl"></span> All Total: <asp:Label  CssClass="HeaderCls" ID="lblAllTotal" Text="0" runat="server"></asp:Label> </p>
                                ...
                                <Columns>
                                        ...
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>
                                             <asp:HiddenField runat="server" ID="HFDWSPDate" Value='<%#Eval("DWSPDate")%>' />

                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:BoundField DataField="DWSPDate" HeaderText="Date" />
                                    <asp:TemplateField HeaderText="General Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtGeneralAmount" runat="server" Text='<%#Eval("GeneralAmount") %>' AutoPostBack="True" OnTextChanged="txtGeneralAmount_TextChanged" CssClass="form-control form-control-sm mb-3 clsDecimal"></asp:TextBox>
                                                        
                                                        <asp:FilteredTextBoxExtender ID="hh" runat="server"
                                                                                     TargetControlID="txtGeneralAmount"
                                                                                     FilterType="Custom, Numbers"
                                                                                     ValidChars="." />
                                       ...
                                       <asp:TemplateField HeaderText="FCB Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtFCBAmount" runat="server" Text='<%#Eval("FCBAmount") %>' AutoPostBack="True" OnTextChanged="txtFCBAmount_TextChanged" CssClass="form-control form-control-sm mb-3 clsDecimal"></asp:TextBox>
                                                        
                                                        <asp:FilteredTextBoxExtender ID="jjgj" runat="server"
                                                                                     TargetControlID="txtFCBAmount"
                                                                                     FilterType="Custom, Numbers"
                                                                                     ValidChars="." />
                                          ...
                                          <asp:TemplateField HeaderText="Campaign Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtCampaignAmount" runat="server" Text='<%#Eval("CampaignAmount") %>' AutoPostBack="True" OnTextChanged="txtCampaignAmount_TextChanged" CssClass="form-control form-control-sm mb-3 clsDecimal"></asp:TextBox>
                                                        
                                                        <asp:FilteredTextBoxExtender ID="fjfjfjfhjf" runat="server"
                                                                                     TargetControlID="txtCampaignAmount"
                                                                                     FilterType="Custom, Numbers"
                                                                                     ValidChars="." />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <asp:LinkButton  runat="server"  OnClick="Unnamed_Click"  class="btn btnMyDesignReset   btn-sm"  ><i class="fa fa-retweet" aria-hidden="true"></i>&nbsp; Reset </asp:LinkButton>
                                         ...
                                         <asp:LinkButton  runat="server" ID="btnAdd"  OnClick="btnAdd_Click"  class="btn btnMyDesignAddtoList  btn-sm"  ><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; Back to  Main Page </asp:LinkButton>
