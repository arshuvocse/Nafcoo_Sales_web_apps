...
public partial class DWSP_AMDayWiseDWSPSetup : System.Web.UI.Page
{
    ...
    private bool Validation()
    {
        ...
        if (amount.Text != lblAllTotal.Text)
        {
             
            ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "faildalert('" + "Total Target & Your Submitted Total must be Same!!" + "','Faild');", true);
            return false;
        }
        //Int32 count = 0;
