<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="DivisionEntry.aspx.cs" Inherits="Thana_UI_DistrictEntry" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> Division Setup </div>

                <div class="ms-auto">
                    <div class="btn-group">


                        <a href="Division_View.aspx" class="btn btn-sm btn-sm btn-outline-info"><i class="fa fa-backward"></i>&nbsp; Back to List</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="form-group row">
                                    <label for="ThanaName" class="col-sm-3 col-form-label"> Division Name: </label>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="tbxDivision" runat="server" class="form-control form-control-sm"></asp:TextBox>
