...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        row += "<td><button class='btn-outline-warning btn-xs mb-1 mb-md-0'  type='button'  onclick='editClick(" + result[i].DivisionId + ")'><i class='bx bxs-edit' aria-hidden='true'></i></button> </td>";
                        row += "</tr>";
        ...
        {
            location.href = '../Thana_UI/DivisionEntry.aspx?id=' + id + '';
        }
