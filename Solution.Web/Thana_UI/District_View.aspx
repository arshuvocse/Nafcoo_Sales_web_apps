<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="District_View.aspx.cs" Inherits="Thana_UI_District_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><i class="bx bx-customize"></i> District List</div>
    ...
    <script>
        ...
        function GetdistrictAllInfo() {

            var urlpath = 'District_View.aspx/GET_District_All_List';
            $.ajax({
                url: urlpath,
                type: 'post',
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        row += "<td>" + un(result[i].Lat) + "</td>";
                        row += "<td>" + un(result[i].Long) + "</td>";
                        ...
                        //}
                        row += "<td><button class='btn-outline-warning btn-xs mb-1 mb-md-0'  type='button'  onclick='editClick(" + result[i].DistrictId + ")'><i class='bx bxs-edit' aria-hidden='true'></i></button> </td>";
                        //row += "<td><button class='btn-outline-warning btn-xs mb-1 mb-md-0' onclick='editClick(" + result[i].DistrictId + ")'><i class='fas fa-pen' aria-hidden='true'></i></button> </td>";
                        row += "</tr>";
        ...
        function editClick(id) {
            location.href = '../Thana_UI/DistrictEntry.aspx?id=' + id + '';
        }
