<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NewMasterPage.master" AutoEventWireup="true" CodeFile="PromoChallanReport.aspx.cs" Inherits="PromoAlloc_PromoChallanReport" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="table-responsive" id="MainGradeDiv" style="height: auto !important;">
                                        ...
                                        <asp:GridView ID="masterGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="PromoChallanId,IsForwardAble"
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="btnForward" runat="server" CommandArgument="<%# Container.DataItemIndex %>" class="btn-info  btn-sm mb-1 mb-md-0"
                                                            ...
                                                            OnClick="btnForward_Click"><i class="fa fa-send"> Send to Depot </i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
