...
namespace Library.BLL.SInventory_BLL
{
    public class InvoiceBLL
    {
        ...
        public DataTable GETpaySlip(string districtId)
        {

            return aInvoiceDal.get_pay_Slip_DAL(districtId);
        }
        ...
        public bool SaveInvoice(Invoice aInvoice, out int invoiceId, out string invoiceNo)
        {
            ...
            batchn = HttpContext.Current.Session["RootOrd"].ToString() + "-" + batchn;
       ...
       public DataTable ProductInfoid(string comUnitId, string productCode)
       {
           return aInvoiceDal.ProductInfoIdDAL(comUnitId, productCode);
       }
       ...
       public DataTable LoadProductQty(string orderid, string productCode)
       {
        ...
        public Int32 UpdateInvoiceDetailNotExist()
        {
            return aInvoiceDal.UpdateInvoiceDetailNotExist();
        }
        ...
        public DataTable CheckInvoiceDetailExistOrNot(string invoiceNo)
        {
            return aInvoiceDal.CheckInvoiceDetailExistOrNot(invoiceNo);
        }
        ...
        {
            return aInvoiceDal.GetCustomerPaymebtType(customerMasterId);
        }

        public void UpdateDeliveryStatus()
        {
            aInvoiceDal.UpdateDeliveryStatus();
        }

        public void ProcessProbationalDiscount(string invoiceNo)
        {
            aInvoiceDal.ProcessProbationalDiscount(invoiceNo);
        }

        public DataTable LoadProductOrderDetails(string orderDetailsId)
        {
           return aInvoiceDal.LoadProductOrderDetails(orderDetailsId);
        }

        public DataTable CheckInvoiceExistOrNot(string invoiceNo)
        {
            return aInvoiceDal.CheckInvoiceExistOrNot(invoiceNo);
        }
    }
}
