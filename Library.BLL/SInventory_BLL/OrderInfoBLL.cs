...
namespace Library.BLL.SInventory_BLL
{
    public class OrderInfoBLL
    {
        ...
        public Int32 GenerateInvoiceByOrderId(int orderId, int userId, string batchn)
        {
            return aOrderInfoDal.GenerateInvoiceByOrderId(orderId, userId, batchn);
        }
        ...
        {
            return aOrderInfoDal.GetTradeTerm(amount);
        }
