...
namespace Library.BLL.SInventory_BLL
{
    public class ChalanBLL
    {
        ...
        public int DCStockIn2(DCStockNew aDcStockNew, int userId)
        {
            ...
            aChalanDal.ChalanUpdate(aDcStockNew.ChalanId.ToString(), userId);
        ...
        public DataTable GetUserWiseDepot(int depotId)
        {
            return aChalanDal.GetUserWiseDepot(depotId);
        }
    }
}
